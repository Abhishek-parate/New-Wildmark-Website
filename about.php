...
<!-- HERO -->
 <header class="relative h-[50vh] md:h-[60vh] lg:h-[120vh] flex items-end"
        style="background: url('https://wildmarkresort.com/images/webp/acc/about.webp') center/cover no-repeat">
    ...
    <div class="max-w-7xl mx-auto px-4 md:px-6">
        ...
        <div class="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div data-aos="fade-left">
                <img src="https://wildmarkresort.com/images/webp/main-outdoor.webp" alt="Wildmark Resort Kanha"
    ...
    <div class="max-w-7xl mx-auto px-4 md:px-6">
        ...
        <div class="grid lg:grid-cols-2 gap-12 items-center mb-16">
            <div data-aos="fade-right" >
                <img src="https://wildmarkresort.com/images/webp/wildmarkresort (32).webp" alt="Wildmark Resort" class="rounded-2xl shadow-2xl w-full h-[400px] md:h-[500px] object-cover" />
            </div>
            <div data-aos="fade-left" >
        ...
        <div class="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div class="order-1 lg:order-2" data-aos="fade-left" >
                <img src="https://wildmarkresort.com/images/webp/acc/kanhpage.webp" alt="Kanha Wildlife" class="rounded-2xl shadow-2xl w-full h-[400px] md:h-[500px] object-cover" />
            </div>
        </div>
    </div>
</section>
