...
<head>
  ...
  <title>About Us - Wildmark Resort Kanha | Luxury Wildlife Resort Experience</title>
...
<section class="py-16 md:py-24 bg-[#121212]" style="padding-bottom: 30px;">
  ...
  <!-- FAQs Section - About Page Related -->
<section class="py-16 md:py-24 bg-[#121212]">
  <div class="container mx-auto max-w-4xl px-4 md:px-6">
    <div class="text-center mb-12 md:mb-16">
      ...
      <p class="text-sm md:text-base text-gray-300 max-w-2xl mx-auto leading-relaxed" data-aos="fade-up" data-aos-delay="200">
        Everything you need to know about Wildmark Resort Kanha
      </p>
    </div>
    ...
    <div class="space-y-4" data-aos="fade-up" data-aos-duration="1000">
      ...
      <div class="faq-item bg-neutral-900 border border-neutral-800 rounded-xl overflow-hidden">
        <button class="faq-question w-full text-left px-6 py-5 flex justify-between items-center hover:bg-neutral-800 transition">
          <span class="text-base md:text-lg font-serif text-white pr-4">What makes Wildmark Resort unique compared to other resorts in Kanha?</span>
        ...
        <div class="faq-answer max-h-0 overflow-hidden transition-all duration-300 ease-in-out">
          <div class="px-6 py-5 bg-neutral-800/50 border-t border-neutral-700">
            <p class="text-sm md:text-base text-gray-300 leading-relaxed">
              Wildmark Resort stands out with its perfect blend of luxury and nature. Located in a pristine natural setting near Kanha National Park, we offer premium accommodations with modern amenities while maintaining an authentic wilderness experience. Our multiple TripAdvisor Travellers' Choice Awards (2020, 2021, 2022, 2025) reflect our commitment to exceptional hospitality, expert safari guidance, and sustainable tourism practices.
            </p>
          </div>
        </div>
      </div>
      ...
      <div class="faq-item bg-neutral-900 border border-neutral-800 rounded-xl overflow-hidden">
        <button class="faq-question w-full text-left px-6 py-5 flex justify-between items-center hover:bg-neutral-800 transition">
          <span class="text-base md:text-lg font-serif text-white pr-4">How close is Wildmark Resort to Kanha National Park?</span>
          <svg class="faq-icon w-6 h-6 text-amber-500 flex-shrink-0 transition-transform duration-300" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7"></path>
          </svg>
        </button>
        <div class="faq-answer max-h-0 overflow-hidden transition-all duration-300 ease-in-out">
          <div class="px-6 py-5 bg-neutral-800/50 border-t border-neutral-700">
            <p class="text-sm md:text-base text-gray-300 leading-relaxed">
              We are strategically located at the doorstep of Kanha National Park, offering easy access to both Kanha-Kisli and Mukki safari zones. This prime location allows you to reach the park gates quickly for early morning safaris, maximizing your chances of wildlife sightings while enjoying the comfort of returning to our resort within minutes.
            </p>
          </div>
        </div>
      </div>
      ...
      <div class="faq-item bg-neutral-900 border border-neutral-800 rounded-xl overflow-hidden">
        <button class="faq-question w-full text-left px-6 py-5 flex justify-between items-center hover:bg-neutral-800 transition">
          <span class="text-base md:text-lg font-serif text-white pr-4">What type of accommodation and amenities does Wildmark Resort offer?</span>
          <svg class="faq-icon w-6 h-6 text-amber-500 flex-shrink-0 transition-transform duration-300" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7"></path>
          </svg>
        </button>
        <div class="faq-answer max-h-0 overflow-hidden transition-all duration-300 ease-in-out">
          <div class="px-6 py-5 bg-neutral-800/50 border-t border-neutral-700">
            <p class="text-sm md:text-base text-gray-300 leading-relaxed">
              Our resort features luxury rooms with modern architecture and premium amenities including comfortable bedding, private sit-outs with garden views, attached bathrooms with hot water, air conditioning, and all essential facilities. We also offer multi-cuisine dining, 24/7 room service, safari booking assistance, expert naturalist guidance, and recreational facilities—all set in a lush green natural environment.
            </p>
          </div>
        </div>
      </div>
      ...
      <div class="faq-item bg-neutral-900 border border-neutral-800 rounded-xl overflow-hidden">
        <button class="faq-question w-full text-left px-6 py-5 flex justify-between items-center hover:bg-neutral-800 transition">
          <span class="text-base md:text-lg font-serif text-white pr-4">Does Wildmark Resort follow eco-friendly and sustainable practices?</span>
          <svg class="faq-icon w-6 h-6 text-amber-500 flex-shrink-0 transition-transform duration-300" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7"></path>
          </svg>
        </button>
        <div class="faq-answer max-h-0 overflow-hidden transition-all duration-300 ease-in-out">
          <div class="px-6 py-5 bg-neutral-800/50 border-t border-neutral-700">
            <p class="text-sm md:text-base text-gray-300 leading-relaxed">
              Yes, sustainability is one of our core values. We are committed to eco-friendly practices that minimize our environmental footprint. We actively participate in wildlife conservation efforts, support local communities, practice responsible waste management, use energy-efficient systems, and promote sustainable tourism. Our goal is to ensure that future generations can experience Kanha's natural beauty just as you do today.
            </p>
          </div>
        </div>
      </div>
      ...
      <div class="faq-item bg-neutral-900 border border-neutral-800 rounded-xl overflow-hidden">
        <button class="faq-question w-full text-left px-6 py-5 flex justify-between items-center hover:bg-neutral-800 transition">
          <span class="text-base md:text-lg font-serif text-white pr-4">What can guests expect to see in Kanha National Park during their stay?</span>
          <svg class="faq-icon w-6 h-6 text-amber-500 flex-shrink-0 transition-transform duration-300" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7"></path>
          </svg>
        </button>
        <div class="faq-answer max-h-0 overflow-hidden transition-all duration-300 ease-in-out">
          <div class="px-6 py-5 bg-neutral-800/50 border-t border-neutral-700">
            <p class="text-sm md:text-base text-gray-300 leading-relaxed">
              Kanha National Park spans 940 square kilometers and is home to diverse wildlife including the Royal Bengal Tiger, Barasingha (the jewel of Kanha), leopards, sloth bears, Indian wild dogs, spotted deer, sambar deer, gaur, and over 300 species of birds. Our expert naturalists and safari guides will help maximize your wildlife sighting opportunities during both morning and evening safaris.
            </p>
          </div>
        </div>
      </div>
      ...
      <div class="faq-item bg-neutral-900 border border-neutral-800 rounded-xl overflow-hidden">
        ...
        <div class="faq-answer max-h-0 overflow-hidden transition-all duration-300 ease-in-out">
          <div class="px-6 py-5 bg-neutral-800/50 border-t border-neutral-700">
            <p class="text-sm md:text-base text-gray-300 leading-relaxed">
              Absolutely! Wildmark Resort is perfect for families. We provide a safe, comfortable environment where children can experience nature and wildlife in a controlled setting. Our spacious rooms, multi-cuisine dining, garden areas, and family-friendly atmosphere make it an ideal destination for creating lasting memories with loved ones. We also offer recreational facilities and can arrange educational nature walks for children.
            </p>
          </div>
        </div>
      </div>
