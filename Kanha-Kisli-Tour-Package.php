...
<head>
  ...
  <title>Kanha Kisli Tour Package</title>
...
<!-- FAQs Section - Kanha Kisli Tour Package -->
    ...
    <div class="space-y-4" data-aos="fade-up" data-aos-duration="1000">
        ...
        <div class="faq-answer max-h-0 overflow-hidden transition-all duration-300 ease-in-out">
          <div class="px-6 py-5 bg-neutral-800/50 border-t border-neutral-700">
            ...
            <p class="text-sm md:text-base text-gray-300 leading-relaxed mt-3">
              This multi-zone experience maximizes your wildlife sighting opportunities and lets you explore the diverse ecosystems of Kanha National Park.
            </p>
          </div>
        </div>
      </div>
      ...
      <div class="faq-item bg-black border border-neutral-800 rounded-xl overflow-hidden">
        ...
        <div class="faq-answer max-h-0 overflow-hidden transition-all duration-300 ease-in-out">
          <div class="px-6 py-5 bg-neutral-800/50 border-t border-neutral-700">
            <p class="text-sm md:text-base text-gray-300 leading-relaxed mb-3">
              The package includes everything for a complete Kanha experience:
            </p>
            <ul class="text-sm md:text-base text-gray-300 space-y-2 ml-4">
              <li class="flex items-start gap-2">
                <span class="text-amber-500">•</span>
                <span><strong>Accommodation:</strong> 2 nights at Wildmark Resort</span>
              </li>
              <li class="flex items-start gap-2">
                <span class="text-amber-500">•</span>
                <span><strong>Meals:</strong> All meals - Breakfast (including safari breakfast), Lunch, Hi-tea, and Dinner</span>
              </li>
              <li class="flex items-start gap-2">
                <span class="text-amber-500">•</span>
                <span><strong>Safaris:</strong> 4 jungle safaris (1 afternoon + 2 mornings + 1 afternoon) across three zones</span>
              </li>
              <li class="flex items-start gap-2">
                <span class="text-amber-500">•</span>
                <span><strong>Water:</strong> Daily one bottle of mineral water (500ml) per guest at resort</span>
              </li>
              <li class="flex items-start gap-2">
                <span class="text-amber-500">•</span>
                <span><strong>Transportation:</strong> Pick-up and drop from/to Jabalpur Airport or Railway Station</span>
              </li>
            </ul>
          </div>
        </div>
      ...
      <div class="faq-item bg-black border border-neutral-800 rounded-xl overflow-hidden">
        <button class="faq-question w-full text-left px-6 py-5 flex justify-between items-center hover:bg-neutral-800 transition">
          <span class="text-base md:text-lg font-serif text-white pr-4">What is the detailed day-wise itinerary?</span>
          <svg class="faq-icon w-6 h-6 text-amber-500 flex-shrink-0 transition-transform duration-300" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7"></path>
          </svg>
        </button>
        <div class="faq-answer max-h-0 overflow-hidden transition-all duration-300 ease-in-out">
          <div class="px-6 py-5 bg-neutral-800/50 border-t border-neutral-700">
            ...
            <ul class="text-sm md:text-base text-gray-300 space-y-1 ml-4 mb-3">
              <li>• Arrival at Jabalpur and transfer to Wildmark Resort</li>
              <li>• Lunch at 1:00 PM</li>
              <li>• Afternoon safari in Kanha Core Zone</li>
            ...
            <ul class="text-sm md:text-base text-gray-300 space-y-1 ml-4 mb-3">
              <li>• Morning safari in Kanha Core Zone with breakfast served in safari</li>
              <li>• Return and relax by the pool</li>
              <li>• Lunch at 1:00 PM</li>
              <li>• Afternoon safari in Kisli Core Zone</li>
              <li>• Hi-tea after safari</li>
              <li>• Dinner at 8:30 PM</li>
            </ul>
            ...
            <ul class="text-sm md:text-base text-gray-300 space-y-1 ml-4">
              <li>• Morning safari in Sarhi Core Zone with breakfast served in safari</li>
              <li>• Check-out by 11:30 AM</li>
              <li>• Transfer back to Jabalpur</li>
            </ul>
          </div>
        </div>
      </div>
      ...
      <div class="faq-item bg-black border border-neutral-800 rounded-xl overflow-hidden">
        ...
        <div class="faq-answer max-h-0 overflow-hidden transition-all duration-300 ease-in-out">
          <div class="px-6 py-5 bg-neutral-800/50 border-t border-neutral-700">
            <p class="text-sm md:text-base text-gray-300 leading-relaxed mb-3">
              Each zone offers unique wildlife experiences:
            </p>
            <ul class="text-sm md:text-base text-gray-300 space-y-3 ml-4">
              <li class="flex items-start gap-2">
                <span class="text-amber-500">•</span>
                <span><strong>Kanha Zone (2 safaris):</strong> Most popular zone with scenic beauty, high tiger sighting probability including the famous Tigress Neelam, and excellent Barahsingha (swamp deer) sightings</span>
              </li>
              <li class="flex items-start gap-2">
                <span class="text-amber-500">•</span>
                <span><strong>Kisli Zone (1 safari):</strong> Rich flora and fauna, home to Barahsingha (state animal of MP), exceptional birdwatching opportunities, and diverse wildlife</span>
              </li>
              <li class="flex items-start gap-2">
                <span class="text-amber-500">•</span>
                <span><strong>Sarhi Zone (1 safari):</strong> Known for scenic landscapes, sloth bear sightings, wild dogs (dholes), leopards, and prime birdwatching locations</span>
              </li>
            </ul>
          </div>
        </div>
        ...
        <div class="faq-answer max-h-0 overflow-hidden transition-all duration-300 ease-in-out">
          <div class="px-6 py-5 bg-neutral-800/50 border-t border-neutral-700">
            <ul class="text-sm md:text-base text-gray-300 space-y-2 ml-4">
              <li class="flex items-start gap-2">
                <span class="text-amber-500">•</span>
                <span><strong>Safari Booking:</strong> No refund on safari booking as this is a package deal</span>
              </li>
              <li class="flex items-start gap-2">
                <span class="text-amber-500">•</span>
            ...
            <p class="text-sm md:text-base text-gray-300 leading-relaxed mt-3">
              <strong>Important:</strong> 100% advance payment is required for booking confirmation.
            </p>
          </div>
        </div>
      </div>
      ...
      <div class="faq-item bg-black border border-neutral-800 rounded-xl overflow-hidden">
        <button class="faq-question w-full text-left px-6 py-5 flex justify-between items-center hover:bg-neutral-800 transition">
          <span class="text-base md:text-lg font-serif text-white pr-4">What are the safari timings for morning and afternoon sessions?</span>
          <svg class="faq-icon w-6 h-6 text-amber-500 flex-shrink-0 transition-transform duration-300" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7"></path>
          </svg>
        </button>
        <div class="faq-answer max-h-0 overflow-hidden transition-all duration-300 ease-in-out">
          <div class="px-6 py-5 bg-neutral-800/50 border-t border-neutral-700">
            ...
            <ul class="text-sm md:text-base text-gray-300 space-y-2 ml-4">
              <li class="flex items-start gap-2">
                <span class="text-amber-500">•</span>
                <span><strong>Morning Safari (Winter - Oct to Feb):</strong> 6:00 AM - 11:00 AM</span>
              </li>
              <li class="flex items-start gap-2">
                <span class="text-amber-500">•</span>
                <span><strong>Morning Safari (Summer - Mar to June):</strong> 5:30 AM - 10:30 AM</span>
              </li>
              <li class="flex items-start gap-2">
                <span class="text-amber-500">•</span>
                <span><strong>Afternoon Safari (Winter):</strong> 2:30 PM - 5:30 PM</span>
              </li>
              <li class="flex items-start gap-2">
                <span class="text-amber-500">•</span>
                <span><strong>Afternoon Safari (Summer):</strong> 3:00 PM - 6:00 PM</span>
              </li>
            </ul>
            <p class="text-sm md:text-base text-gray-300 leading-relaxed mt-3">
              Each safari lasts approximately 3-4 hours. Morning safaris include breakfast served inside the park.
            </p>
          </div>
        </div>
      </div>
      ...
      <div class="faq-item bg-black border border-neutral-800 rounded-xl overflow-hidden">
        <button class="faq-question w-full text-left px-6 py-5 flex justify-between items-center hover:bg-neutral-800 transition">
          <span class="text-base md:text-lg font-serif text-white pr-4">What should I bring for the safaris?</span>
          <svg class="faq-icon w-6 h-6 text-amber-500 flex-shrink-0 transition-transform duration-300" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7"></path>
          </svg>
        </button>
        <div class="faq-answer max-h-0 overflow-hidden transition-all duration-300 ease-in-out">
          <div class="px-6 py-5 bg-neutral-800/50 border-t border-neutral-700">
            ...
            <ul class="text-sm md:text-base text-gray-300 space-y-2 ml-4">
              <li class="flex items-start gap-2">
                <span class="text-amber-500">•</span>
                <span><strong>Clothing:</strong> Neutral-colored clothes (avoid bright colors), warm jacket for early mornings, hat/cap, comfortable shoes</span>
              </li>
              <li class="flex items-start gap-2">
                <span class="text-amber-500">•</span>
                <span><strong>Photography:</strong> Camera with good zoom lens, extra batteries and memory cards (camera charges apply)</span>
              </li>
              <li class="flex items-start gap-2">
                <span class="text-amber-500">•</span>
                <span><strong>Sun Protection:</strong> Sunglasses, sunscreen, lip balm</span>
              </li>
              <li class="flex items-start gap-2">
                <span class="text-amber-500">•</span>
                <span><strong>Essentials:</strong> Binoculars, small backpack, ID proof (mandatory)</span>
              </li>
              <li class="flex items-start gap-2">
                <span class="text-amber-500">•</span>
                <span><strong>Note:</strong> Water bottles in safari are chargeable; plastic bags are prohibited</span>
              </li>
            </ul>
          </div>
        </div>
      ...
      <div class="faq-item bg-black border border-neutral-800 rounded-xl overflow-hidden">
        <button class="faq-question w-full text-left px-6 py-5 flex justify-between items-center hover:bg-neutral-800 transition">
          <span class="text-base md:text-lg font-serif text-white pr-4">What wildlife can I expect to see during the 4 safaris?</span>
          <svg class="faq-icon w-6 h-6 text-amber-500 flex-shrink-0 transition-transform duration-300" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7"></path>
          </svg>
        </button>
        <div class="faq-answer max-h-0 overflow-hidden transition-all duration-300 ease-in-out">
          <div class="px-6 py-5 bg-neutral-800/50 border-t border-neutral-700">
            <p class="text-sm md:text-base text-gray-300 leading-relaxed mb-3">
              Kanha is home to incredible biodiversity:
            </p>
            <ul class="text-sm md:text-base text-gray-300 space-y-2 ml-4">
              <li class="flex items-start gap-2">
                <span class="text-amber-500">•</span>
                <span><strong>Big Cats:</strong> Royal Bengal Tiger (including famous Tigress Neelam), Leopards</span>
              </li>
              <li class="flex items-start gap-2">
                <span class="text-amber-500">•</span>
                <span><strong>Unique Species:</strong> Barahsingha (hard-ground swamp deer) - state animal of MP, found only in Kanha</span>
              </li>
              <li class="flex items-start gap-2">
                <span class="text-amber-500">•</span>
                <span><strong>Herbivores:</strong> Spotted deer (Chital), Sambar deer, Barking deer, Indian Gaur (bison)</span>
              </li>
              <li class="flex items-start gap-2">
                <span class="text-amber-500">•</span>
                <span><strong>Other Mammals:</strong> Sloth bears, Wild dogs (Dholes), Indian wild boar, Langurs, Jackals</span>
              </li>
              <li class="flex items-start gap-2">
                <span class="text-amber-500">•</span>
                <span><strong>Birds:</strong> 300+ species including Indian roller, paradise flycatcher, crested serpent eagle</span>
              </li>
            </ul>
            <p class="text-sm md:text-base text-gray-300 leading-relaxed mt-3">
              <strong>Note:</strong> Wildlife sightings are subject to nature and cannot be guaranteed, but 4 safaris across 3 zones significantly increase your chances!
            </p>
          </div>
        </div>
      </div>
      ...
      <div class="faq-item bg-black border border-neutral-800 rounded-xl overflow-hidden">
        ...
        <div class="faq-answer max-h-0 overflow-hidden transition-all duration-300 ease-in-out">
          <div class="px-6 py-5 bg-neutral-800/50 border-t border-neutral-700">
            <p class="text-sm md:text-base text-gray-300 leading-relaxed mb-3">
              Absolutely! This is our most recommended package for first-time visitors because:
            </p>
            <ul class="text-sm md:text-base text-gray-300 space-y-2 ml-4">
              <li class="flex items-start gap-2">
                <span class="text-amber-500">•</span>
                <span><strong>Comprehensive Coverage:</strong> You experience all three major zones in one trip</span>
              </li>
              <li class="flex items-start gap-2">
                <span class="text-amber-500">•</span>
                <span><strong>Multiple Safaris:</strong> 4 safaris give you excellent chances to spot diverse wildlife</span>
              </li>
              <li class="flex items-start gap-2">
                <span class="text-amber-500">•</span>
                <span><strong>Balanced Schedule:</strong> Mix of adventure and relaxation with pool time on Day 2</span>
              </li>
              <li class="flex items-start gap-2">
                <span class="text-amber-500">•</span>
                <span><strong>Ideal Duration:</strong> 3 days/2 nights is perfect - not too rushed, not too long</span>
              </li>
              <li class="flex items-start gap-2">
                <span class="text-amber-500">•</span>
                <span><strong>All-Inclusive:</strong> No stress about planning meals or transportation</span>
              </li>
            </ul>
          </div>
        </div>
      ...
      <div class="faq-item bg-black border border-neutral-800 rounded-xl overflow-hidden">
        ...
        <div class="faq-answer max-h-0 overflow-hidden transition-all duration-300 ease-in-out">
          <div class="px-6 py-5 bg-neutral-800/50 border-t border-neutral-700">
            <p class="text-sm md:text-base text-gray-300 leading-relaxed mb-3">
              Items not included and charged separately:
            </p>
            <ul class="text-sm md:text-base text-gray-300 space-y-2 ml-4">
              <li class="flex items-start gap-2">
                <span class="text-amber-500">•</span>
                <span><strong>Camera Charges:</strong> Forest department fees for still cameras, video cameras (mandatory if carrying)</span>
              </li>
              <li class="flex items-start gap-2">
                <span class="text-amber-500">•</span>
                <span><strong>Safari Water:</strong> Additional water bottles required during safari (resort water is included)</span>
              </li>
              <li class="flex items-start gap-2">
                <span class="text-amber-500">•</span>
                <span><strong>Extra Food/Drinks:</strong> Any beverages or food ordered beyond the meal plan</span>
              </li>
              <li class="flex items-start gap-2">
                <span class="text-amber-500">•</span>
                <span><strong>Personal Expenses:</strong> Laundry, tips, telephone calls, shopping</span>
              </li>
              <li class="flex items-start gap-2">
                <span class="text-amber-500">•</span>
                <span><strong>Weekend Pricing:</strong> Package rates are for weekends; marginal discount available for weekday travel</span>
              </li>
            </ul>
          </div>
        </div>
