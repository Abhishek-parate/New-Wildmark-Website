...
.why-choose-card .icon-wrapper {
  ...
  margin: 0 0 1rem 0; /* Changed from auto to 0 for left alignment */
...
@media (max-width: 767px) {
  ...
  <section id="home" class="relative h-screen flex items-center justify-center hero-section overflow-hidden"
    data-aos="fade">
    <!-- Carousel Background Images - Video Style -->
    <div class="absolute inset-0 hero-carousel">
      <!-- Image 1 - Tiger in Kanha -->
      <div class="hero-slide active absolute inset-0 opacity-100">
        <div class="hero-image absolute inset-0" style="background: url(&quot;images/home.webp&quot;) center/cover"></div>
      </div>

      <!-- Image 2 - Resort View -->
      <div class="hero-slide absolute inset-0 opacity-0">
        <div class="hero-image absolute inset-0" style="background: url(&quot;images/home2.webp&quot;) center/cover"></div>
      </div>

      <!-- Image 3 - Bengal Tiger -->
      <div class="hero-slide absolute inset-0 opacity-0">
        <div class="hero-image absolute inset-0" style="background: url(&quot;images/home3.webp&quot;) center/cover">
        </div>
      </div>

      <!-- Image 4 - Kanha Landscape -->
      <div class="hero-slide absolute inset-0 opacity-0">
        <div class="hero-image absolute inset-0" style="background: url(&quot;images/home5.webp&quot;) center/cover"></div>
      </div>

      <!-- Image 5 - Deer in Forest -->
      <div class="hero-slide absolute inset-0 opacity-0">
        <div class="hero-image absolute inset-0" style="background: url(&quot;images/home5.jpg&quot;) center/cover"></div>
      </div>
    </div>
  </section>

  <!-- Intro / Strapline -->
  <section id="intro" class="relative py-12 md:py-20 flex items-center bg-[#121212]">
    <div class="mx-auto w-full max-w-8xl text-center">
      ...
      <div class="text-center z-10 px-4 md:px-6 w-full max-w-7xl relative mx-auto">
        ...
        <h5
          class="text-xl md:text-xl lg:text-xl text-amber-500 font-serif font-light mb-6 md:mb-8 tracking-wide hero-title"
          data-aos="fade-up" data-aos-duration="1200" data-aos-delay="300">
  ...
  <section class="py-12 md:py-16 bg-neutral-900 conservation-section overflow-hidden">
    <div class="container mx-auto max-w-6xl px-4 md:px-6">
      <div class="grid lg:grid-cols-2 items-center gap-6 md:gap-10">
        ...
        <div
          class="conservation-video relative w-full h-[360px] md:h-[460px] lg:h-[520px] overflow-hidden rounded-xl shadow-xl"
          data-aos="fade-right" data-aos-duration="1000">
          <video class="absolute inset-0 w-full h-full object-cover" autoplay muted loop playsinline preload="metadata"
            id="conservationVideo">
  ...
  <section id="rooms" class="py-12 md:py-16 bg-neutral-900">
    <div class="max-w-6xl mx-auto px-4 md:px-6">
      ...
      <div class="grid md:grid-cols-2 gap-8 md:gap-12">
        ...
        <div class="panel" data-tab="machaan">
          <h5 class="text-xl md:text-xl lg:text-xl font-serif font-light tracking-wide hero-title mt-4"
            data-aos="fade-up" data-aos-duration="1200" data-aos-delay="300">
            Room Highlights:
          </h5>
          <ul class="grid grid-cols-1 sm:grid-cols-1 gap-2 text-gray-300 text-sm mt-4">
            <li>
              <i class="fa-solid fa-check icon-check mr-2 mb-2"></i>Spacious,
              comfy AC rooms
            </li>
            <li>
              <i class="fa-solid fa-check icon-check mr-2 mb-2"></i>Ideal for
              couples & solo travellers
            </li>
            <li>
              <i class="fa-solid fa-check icon-check mr-2 mb-2"></i>Private
              sit-out with garden views
            </li>
            <li>
              <i class="fa-solid fa-check icon-check mr-2 mb-2"></i>Peaceful
              forest-side ambience
            </li>
            <li>
              <i class="fa-solid fa-check icon-check mr-2 mb-2"></i>Perfect
              for couples or solo travelers.
            </li>
            <li>
              <i class="fa-solid fa-check icon-check mr-2 mb-2"></i>With
              garden views and a private sit-out.
            </li>
          </ul>
        </div>
        <div class="panel" data-tab="machaan">
          <img src="images/beded2.webp" class="rounded-xl w-full h-64 object-cover"
            alt="Machaan" />
        </div>
        ...
        <div class="panel hidden md:col-span-2" data-tab="superdeluxe">
          <!-- 3 Column Grid for Room Highlights -->
          <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mt-4">
            <!-- Column 1: Room Highlights -->
            <div>
              <h6 class="font-semibold text-base mb-3">Room Highlights:</h6>
              <ul class="space-y-2 text-gray-300 text-sm">
                <li>
                  <i class="fa-solid fa-check icon-check mr-2 text-amber-500"></i>Perfect for families & small groups
                </li>
                <li>
                  <i class="fa-solid fa-check icon-check mr-2 text-amber-500"></i>Larger room with multiple bedding
                  options
                </li>
                <li>
                  <i class="fa-solid fa-check icon-check mr-2 text-amber-500"></i>AC Comfy Rooms with modern amenities
                </li>
                <li>
                  <i class="fa-solid fa-check icon-check mr-2 text-amber-500"></i>Comfortable stay for up to 4 guests
                </li>
                <li>
                  <i class="fa-solid fa-check icon-check mr-2 text-amber-500"></i>Perfect for Family or Friends Group
                </li>
                <li>
                  <i class="fa-solid fa-check icon-check mr-2 text-amber-500"></i>Features two beds (king/double)
                </li>
              </ul>
            </div>

           <!-- Column 2: Activities at Wildmark Resorts -->
            <div>
              <h6 class="font-semibold text-base mb-3">
                Activities at Wildmark Resorts:
              </h6>
              <ul class="space-y-2 text-gray-300 text-sm">
                <li>
                  <i class="fa-solid fa-binoculars text-amber-500"></i>
                  Jungle safaris with guided night drives
                </li>
                <li>
                ...
                <li>
                  ...
                  Bonfire evenings & private dining
                </li>
                <li>
                  <i class="fa-solid fa-utensils  text-amber-500"></i>
                  Bush-style outdoor meals
                </li>
                <li>
                  <i class="fa-solid fa-table-tennis-paddle-ball text-amber-500"></i>
                  Indoor games & outdoor sports
                </li>
                <li>
                  <i class="fa-solid fa-person-swimming text-amber-500"></i>
            ...
            <!-- Column 3: Unparalleled Room Amenities -->
            <div>
              <h6 class="font-semibold text-base mb-3">
                Unparalleled Room Amenities:
              </h6>
              <ul class="space-y-2 text-gray-300 text-sm">
                <li>
                  <i class="fa-solid fa-bed text-amber-500"></i>
                  Spacious AC rooms & private sit-outs
                </li>
                <li>
                ...
                <li>
                  <i class="fa-solid fa-bath text-amber-500"></i>
                  Modern Washrooms
                </li>
                <li>
                  <i class="fa-solid fa-wine-bottle text-amber-500"></i>
                  Select rooms with mini-bars
                </li>
                <li>
                ...
                <li>
                  ...
                  Pet-friendly & wheelchair-accessible rooms
                </li>
                <li>
                ...
                <li>
                  ...
                  Safari booking & pick-up/drop assistance
                </li>
              </ul>
            </div>
          </div>
      ...
      <div class="grid lg:grid-cols-2">
        ...
        <div class="bg-stone-700 flex items-center px-6 md:px-12 lg:px-12 py-12 md:py-12 roots-content"
          ...
          <div>
            ...
            <p class="text-sm md:text-base text-gray-200 mb-6 md:mb-4 leading-relaxed text-justify" data-aos="fade-up"
              data-aos-delay="400">
              Welcome to the wild wonders of Kanha Kisli Tiger Reserve where
            ...
            <p class="text-sm md:text-base text-gray-200 mb-6 md:mb-10 leading-relaxed text-justify" data-aos="fade-up"
              data-aos-delay="400">
  ...
  <section class="py-12 md:py-20 px-4 md:px-6 bg-neutral-900 testimonial-section overflow-hidden">
    <div class="w-full max-w-7xl mx-auto">
      ...
      <div class="flex justify-center mt-8 md:mt-10 gap-2.5" id="testimonialDots">
        ...
        <button class="testimonial-nav-dot w-3 h-3 rounded-full bg-gray-400 transition-all duration-300 hover:scale-125"
  ...
  <section id="destinations" class="py-12 md:py-20 px-4 md:px-6 bg-black destinations-section overflow-hidden">
    <div class="container mx-auto max-w-7xl">
      ...
      <div class="text-center mb-10 md:mb-16">
        ...
        <p class="text-sm md:text-base text-gray-300 max-w-5xl mx-auto mb-2 md:mb-3 leading-relaxed" data-aos="fade-up"
          data-aos-delay="200">
        ...
        <div class="max-w-xl w-full">
          ...
          <div class="mb-6 md:mb-8" data-aos="fade-up" data-aos-delay="200">
            <div class="flex items-start gap-3 md:gap-4">
              <div class="flex-shrink-0 mt-1">
                <div class="w-10 h-10 md:w-12 md:h-12 bg-amber-500/20 rounded-full flex items-center justify-center">
          ...
          <div class="pt-2 md:pt-4" data-aos="fade-up" data-aos-delay="700">
            <a href="#book"
              ...
              <svg class="w-4 h-4 md:w-5 md:h-5 group-hover:scale-110 transition" fill="none" stroke="currentColor"
                viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
