...
.testimonial-card:hover {
    ...
    box-shadow: 0 10px 25px rgba(142, 22, 22, 0.15);
}
...
.tour-card:hover {
    ...
    box-shadow: 0 12px 40px rgba(142, 22, 22, 0.35);
}
...
.conservation-content-card p {
    color: var(--text1) !important;
}

.conservation-content-card h2 {
    color: var(--text2) !important;
}

.conservation-content-card .text-amber-500 {
    color: var(--text2) !important;
}

.conservation-content-card a.bg-amber-600 {
    background-color: var(--text2) !important;
    color: var(--bg2) !important;
}

.conservation-content-card a.bg-amber-600:hover {
    background-color: #6e1010 !important;
}

.conservation-content-card a.border-white {
    border-color: var(--text2) !important;
    color: var(--text2) !important;
}

.conservation-content-card a.border-white:hover {
    background-color: var(--text2) !important;
    color: var(--bg2) !important;
}
...
.extraordinary-section .text-amber-500 {
    color: var(--text2) !important;
}
...
.extraordinary-section p {
    color: var(--text1) !important;
}

.extraordinary-section .text-gray-300 {
    color: var(--text1) !important;
}
...
#rooms a.bg-amber-600 {
    background-color: var(--text2) !important;
    color: var(--bg2) !important;
}

#rooms a.bg-amber-600:hover {
    background-color: #6e1010 !important;
}
...
.why-choose-section .text-amber-500 {
    color: var(--text2) !important;
}

.why-choose-section .text-gray-300 {
    color: var(--text1) !important;
}
...
.roots-content .text-gray-200 {
    color: var(--text1) !important;
}

.roots-content a.border-white {
    border-color: var(--text2) !important;
    color: var(--text2) !important;
}

.roots-content a.border-white:hover {
    background-color: var(--text2) !important;
    color: var(--bg2) !important;
}

.roots-content a.bg-amber-600 {
    background-color: var(--text2) !important;
    color: var(--bg2) !important;
}

.roots-content a.bg-amber-600:hover {
    background-color: #6e1010 !important;
}
...
.testimonial-section .text-gray-400 {
...
.destinations-section .text-amber-500 {
    color: var(--text2) !important;
}
...
.destinations-section .text-gray-300 {
    color: var(--text1) !important;
}

.destinations-section .tour-card .bg-neutral-900 {
    background-color: var(--bg2) !important;
}

.destinations-section .tour-card h3 {
    color: var(--text2) !important;
}

.destinations-section .tour-card .text-gray-400 {
    color: rgba(0, 0, 0, 0.5) !important;
}

.destinations-section .tour-card a {
    color: var(--text1) !important;
}

.destinations-section .tour-card a:hover {
    color: var(--text2) !important;
}

.destinations-section .bg-amber-500 {
    background-color: var(--text2) !important;
    color: var(--bg2) !important;
}

/* Location Contact Section */
.location-contact-section .bg-neutral-800 {
    background-color: #c9a96e !important;
}
...
.location-contact-section .text-amber-500 {
    color: var(--text2) !important;
}

.location-contact-section .text-amber-400 {
    color: var(--text2) !important;
}

.location-contact-section .text-gray-300 {
    color: var(--text1) !important;
}

.location-contact-section .text-white {
    color: var(--text1) !important;
}

.location-contact-section .bg-amber-500\/20 {
    background-color: rgba(142, 22, 22, 0.15) !important;
}
...
<!-- Intro / Strapline -->
<section id="intro" class="relative py-8 md:py-20 flex items-center overflow-hidden"
    ...
    <div class="mx-auto w-full max-w-7xl text-center">
        <div class="text-center z-10 px-4 md:px-6 w-full max-w-7xl relative mx-auto">
            ...
            <h5 class="text-xl md:text-xl lg:text-xl font-serif font-light mb-6 md:mb-8 tracking-wide hero-title"
                data-aos="fade-up"   style="color: var(--text2);">
...
<!-- Extraordinary Section -->
<section class="py-12 md:py-20 px-4 md:px-6 extraordinary-section overflow-hidden"
    ...
    <div class="container mx-auto max-w-7xl">
        <div class="text-center mb-8 md:mb-12">
            ...
            <h2 class="text-3xl md:text-5xl font-serif mb-6 md:mb-8" data-aos="zoom-in" >
                No matter where you're going from, we take you there.
            </h2>
            <p class="text-sm md:text-base max-w-6xl mx-auto leading-relaxed mb-2" data-aos="fade-up"
                data-aos-delay="200">
            ...
            <p class="text-sm md:text-base max-w-6xl mx-auto leading-relaxed mb-2" data-aos="fade-up"
                >
                Kanha National Park accommodation also offers walking trails in designated buffer zones, allowing
                adventurous visitors to explore the forest on foot under the guidance of a naturalist.
            </p>
        </div>

        <!-- Carousel -->
        <div class="relative mt-10 md:mt-16" data-aos="fade-up"  >
        ...
        <div class="grid md:grid-cols-2 gap-8 md:gap-12">
            ...
            <div class="panel hidden" data-tab="superdeluxe">
                ...
                <p class="text-sm md:text-base mb-2 md:mb-4 leading-relaxed text-justify mt-4">
                    ...
                    conditioning to ensure a relaxing stay. Enjoy a harmonious blend of style and functionality, perfect
                    for memorable family getaways.
                </p>
            </div>
    ...
    <div class="container mx-auto max-w-7xl">
        <div class="text-center mb-10 md:mb-16">
            ...
            <p class="text-sm md:text-base max-w-7xl mx-auto leading-relaxed" data-aos="fade-up" data-aos-delay="200">
                Nestled at the doorstep of Kanha's pristine wilderness, Wildmark Resort offers the perfect blend of
                comfort and adventure. Our colonial-style cottages, surrounded by lush gardens, provide a serene retreat
                after exhilarating safari experiences.
            </p>
        </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 md:gap-8">
            <div class="why-choose-card" data-aos="fade-up"  data-aos-delay="100">
                ...
                <p>We provide you 2 executive rooms, and 2 suite rooms with living area and private balcony facility.
                </p>
            </div>
            ...
            <div class="why-choose-card" data-aos="fade-up"  >
                ...
                <h4>Lawn View</h4>
                <p>Without compromising nature view, we provide you the luxury amenity with 3 lawn view and super deluxe
                    rooms.</p>
            </div>
            <div class="why-choose-card" data-aos="fade-up"  >
                <div class="icon-wrapper"><i class="fas fa-users"></i></div>
                <h4>Family Suite</h4>
                <p>A more guaranteed connecting room with your parents is available to accommodate in King size bed and
                    bathrooms for an entire family.</p>
            </div>
        </div>
    </div>
</section>
        ...
        <div class="grid lg:grid-cols-2">
            ...
            <div class="flex items-center px-6 md:px-12 lg:px-12 py-12 md:py-12 roots-content"
                ...
                <div>
                    ...
                    <p class="text-sm md:text-base mb-6 md:mb-4 leading-relaxed text-justify" data-aos="fade-up"
                        >
                        Welcome to the wild wonders of Kanha Kisli Tiger Reserve where every turn holds the promise of
                        adventure! At the heart of your journey lies the thrilling tiger safari, a chance to explore
                        four distinct zones: Kanha, Kisli, Mukki & Sarhi.
                    </p>
                    <p class="text-sm md:text-base mb-6 md:mb-10 leading-relaxed text-justify" data-aos="fade-up"
                        >
                        First up, let's venture into the Kanha Core Zone, a realm of open meadows and bamboo forests
                        where Tigress Neelam rules the land. Known affectionately as the Mataram of Kanha Zone, she's
                        joined by her fierce companions Sunaina, Mohini, and Neelima. Keep your camera ready for
                        sightings of the regal Barahsingha and elegant black bucks, adding to the excitement of your
                        safari.
                    </p>
                    <div class="flex gap-3 md:gap-4" data-aos="fade-up" >
...
<section class="py-12 md:py-20 px-4 md:px-6 testimonial-section overflow-hidden" style="background-color: var(--bg2);">
    <div class="w-full max-w-7xl mx-auto">
        <div class="text-center mb-8 md:mb-12" data-aos="fade-up">
            ...
            <div class="flex flex-col md:flex-row items-center justify-center gap-3 md:gap-4 mb-4">
                ...
                <div class="text-center md:text-left">
                    <div class="flex text-2xl md:text-3xl mb-1 justify-center md:justify-start"
                        style="color: var(--text2);">★★★★★</div>
        ...
        <div class="relative px-8 md:px-12" data-aos="fade-up" data-aos-delay="200">
                ...
                <div class="testimonial-carousel flex transition-transform duration-500 ease-in-out"
                    ...
                    <div class="testimonial-card w-full md:w-1/3 flex-shrink-0 px-3 md:px-4">
                        <div class="bg-white text-gray-900 rounded-xl p-5 md:p-6 shadow-xl h-full flex flex-col">
                            ...
                            <p class="text-sm md:text-base leading-relaxed flex-grow" style="color: #374151;">Best
                                resort at Kanha near Khatia Gate! The room was very nice and food was also delicious.
                                Staff was very competitive and polite. Highly recommended for families visiting Kanha
                                National Park.</p>
                        </div>
                    </div>
                    <!-- Review Card 2 -->
                        ...
                        <div class="bg-white text-gray-900 rounded-xl p-5 md:p-6 shadow-xl h-full flex flex-col">
                            <div class="flex items-center mb-4">
                                <div
                                    ...
                                    V</div>
                                <div>
                                    <h3 class="font-bold text-base md:text-lg" style="color: #1a1a1a !important;">Vivek
                                        Kumar</h3>
                                    <p class="text-xs md:text-sm" style="color: rgba(0,0,0,0.5);">1 month ago</p>
                                </div>
                            </div>
                            <div class="flex text-lg mb-3" style="color: var(--text2);">★★★★★</div>
                            <p class="text-sm md:text-base leading-relaxed flex-grow" style="color: #374151;">Wild Mark
                                Resort is perfect for family, couples, solo travelers and business meetings. Excellent
                                stay, amazing food at this price is unbelievable. Room was also very neat and clean.</p>
                        </div>
                    </div>
                    <!-- Review Card 3 -->
                    <div class="testimonial-card w-full md:w-1/3 flex-shrink-0 px-3 md:px-4">
                        <div class="bg-white text-gray-900 rounded-xl p-5 md:p-6 shadow-xl h-full flex flex-col">
                            <div class="flex items-center mb-4">
                                <div
                                    ...
                                    U</div>
                                <div>
                                    <h3 class="font-bold text-base md:text-lg" style="color: #1a1a1a !important;">Utsav
                                        Sharma</h3>
                                    <p class="text-xs md:text-sm" style="color: rgba(0,0,0,0.5);">2 months ago</p>
                                </div>
                            </div>
                            <div class="flex text-lg mb-3" style="color: var(--text2);">★★★★★</div>
                            <p class="text-sm md:text-base leading-relaxed flex-grow" style="color: #374151;">Great
                                property. Should be visited if anyone is planning to visit Kanha National Park. Big
                                lawn, great service, everything was nice. The proximity to the park is unbeatable!</p>
                        </div>
                    </div>
                    <!-- Review Card 4 -->
                    <div class="testimonial-card w-full md:w-1/3 flex-shrink-0 px-3 md:px-4">
                        <div class="bg-white text-gray-900 rounded-xl p-5 md:p-6 shadow-xl h-full flex flex-col">
                            <div class="flex items-center mb-4">
                                <div
                                    ...
                                    S</div>
                                <div>
                                    <h3 class="font-bold text-base md:text-lg" style="color: #1a1a1a !important;">Sneha
                                        Patel</h3>
                                    <p class="text-xs md:text-sm" style="color: rgba(0,0,0,0.5);">2 months ago</p>
                                </div>
                            </div>
                            <div class="flex text-lg mb-3" style="color: var(--text2);">★★★★★</div>
                            <p class="text-sm md:text-base leading-relaxed flex-grow" style="color: #374151;">Absolutely
                                wonderful experience! The staff went above and beyond to make our honeymoon special. The
                                private sit-out in our room was perfect for morning coffee.</p>
                        </div>
                    </div>
                    <!-- Review Card 5 -->
                    <div class="testimonial-card w-full md:w-1/3 flex-shrink-0 px-3 md:px-4">
                        <div class="bg-white text-gray-900 rounded-xl p-5 md:p-6 shadow-xl h-full flex flex-col">
                            <div class="flex items-center mb-4">
                                <div
                                    ...
                                    R</div>
                                <div>
                                    <h3 class="font-bold text-base md:text-lg" style="color: #1a1a1a !important;">Rajesh
                                        Mehta</h3>
                                    <p class="text-xs md:text-sm" style="color: rgba(0,0,0,0.5);">3 months ago</p>
                                </div>
                            </div>
                            <div class="flex text-lg mb-3" style="color: var(--text2);">★★★★★</div>
                            <p class="text-sm md:text-base leading-relaxed flex-grow" style="color: #374151;">The resort
                                exceeded all expectations! Clean rooms, delicious food, and the swimming pool was a
                                great way to relax after safari. Pet-friendly policy was a bonus!</p>
                        </div>
                    </div>
                    <!-- Review Card 6 -->
                    <div class="testimonial-card w-full md:w-1/3 flex-shrink-0 px-3 md:px-4">
                        <div class="bg-white text-gray-900 rounded-xl p-5 md:p-6 shadow-xl h-full flex flex-col">
                            <div class="flex items-center mb-4">
                                <div
                                    ...
                                    A</div>
                                <div>
                                    <h3 class="font-bold text-base md:text-lg" style="color: #1a1a1a !important;">Ananya
                                        Singh</h3>
                                    <p class="text-xs md:text-sm" style="color: rgba(0,0,0,0.5);">4 months ago</p>
                                </div>
                            </div>
                            <div class="flex text-lg mb-3" style="color: var(--text2);">★★★★★</div>
                            <p class="text-sm md:text-base leading-relaxed flex-grow" style="color: #374151;">Perfect
                                location for Kanha safari! Walking distance to the park entrance. The colonial
                                architecture is beautiful and the gardens are well maintained. Food quality is
                                exceptional!</p>
                        </div>
                    </div>
                </div>
            ...
            <!-- Navigation Arrows -->
            <button
                class="absolute left-0 top-1/2 -translate-y-1/2 w-10 h-10 md:w-12 md:h-12 rounded-full shadow-2xl flex items-center justify-center transition-all duration-300 hover:scale-110 z-20"
                style="background-color: var(--bg2); color: var(--text2);" onclick="prevTestimonial()"
            ...
            <button
                class="absolute right-0 top-1/2 -translate-y-1/2 w-10 h-10 md:w-12 md:h-12 rounded-full shadow-2xl flex items-center justify-center transition-all duration-300 hover:scale-110 z-20"
                style="background-color: var(--bg2); color: var(--text2);" onclick="nextTestimonial()"
        ...
        <div class="faq-grid" data-aos="fade-up" >
            ...
            <div class="faq-col">
                ...
                <div class="faq-item border rounded-xl overflow-hidden"
                    style="background-color: var(--bg2); border-color: rgba(142,22,22,0.25);">
                    <button
                        class="faq-question w-full text-left px-5 md:px-6 py-4 md:py-5 flex justify-between items-center transition"
                        style="color: var(--text1);" onmouseover="this.style.backgroundColor='rgba(232,201,153,0.5)';"
                        ...
                        <svg class="faq-icon w-5 h-5 md:w-6 md:h-6 flex-shrink-0 transition-transform duration-300"
                            style="color: var(--text2);" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <div class="faq-answer max-h-0 overflow-hidden transition-all duration-300 ease-in-out">
                        <div class="px-5 md:px-6 py-4 md:py-5 border-t"
                            style="background-color: rgba(232,201,153,0.3); border-top-color: rgba(142,22,22,0.2);">
