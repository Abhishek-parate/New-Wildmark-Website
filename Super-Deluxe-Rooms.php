...
<header class="relative h-[50vh] md:h-[60vh] lg:h-[100vh] flex items-end"
    style="background: url('https://wildmarkresort.com/images/webp/rooms/sdrb1.webp') center/cover no-repeat">
  ...
  <div class="container mx-auto max-w-7xl px-4 md:px-6">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-8 md:gap-12 items-start mb-12">
      ...
      <div class="relative" data-aos="fade-left">
        <div class="rounded-2xl overflow-hidden shadow-2xl border border-amber-500/20">
          <img src="https://wildmarkresort.com/images/delux2.webp" alt="Super Deluxe Room Interior with Open Shower" 
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-8 md:gap-12 items-start">
      ...
      <div class="relative order-2 lg:order-1" data-aos="fade-right">
        <div class="rounded-2xl overflow-hidden shadow-2xl border border-amber-500/20">
          <img src="https://wildmarkresort.com/images/delux3.webp" alt="Super Deluxe Room Garden View and Sitout" 
    ...
    <div class="container mx-auto max-w-7xl px-4 md:px-6">
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        <div class="gallery-item" data-aos="fade-up" data-aos-delay="100">
          <img src="https://wildmarkresort.com/images/delux4.webp" alt="Super Deluxe Room View"
            class="w-full h-80 object-cover" />
        </div>
        <div class="gallery-item" data-aos="fade-up" data-aos-delay="200">
          <img src="https://wildmarkresort.com/images/delux5.webp" alt="Room Interior"
            class="w-full h-80 object-cover" />
        </div>
        <div class="gallery-item" data-aos="fade-up" >
          <img src="https://wildmarkresort.com/images/delux7.webp" alt="Resort View"
            class="w-full h-80 object-cover" />
        </div>
      </div>
    </div>
      ...
      <div class="grid grid-cols-2 md:grid-cols-2 lg:grid-cols-4 gap-6 md:gap-8 max-w-6xl mx-auto">
        ...
        <div class="award-card group" data-aos="fade-up"  data-aos-delay="100">
          <div
            ...
            <img src="https://wildmarkresort.com/images/testimonials1.webp" alt="TripAdvisor Travellers' Choice Award 2020"
        ...
        <div class="award-card group" data-aos="fade-up"  data-aos-delay="200">
          <div
            class="bg-white rounded-2xl p-6 md:p-8 shadow-2xl transition-all duration-300 group-hover:shadow-amber-500/30 group-hover:-translate-y-3 flex items-center justify-center min-h-[320px] md:min-h-[380px]">
            <img src="https://wildmarkresort.com/images/testimonials2.webp" alt="TripAdvisor Travellers' Choice Award 2021"
              class="w-full h-auto max-w-[280px] object-contain award-image">
          </div>
        </div>
        ...
        <div class="award-card group" data-aos="fade-up"  >
          <div
            class="bg-white rounded-2xl p-6 md:p-8 shadow-2xl transition-all duration-300 group-hover:shadow-amber-500/30 group-hover:-translate-y-3 flex items-center justify-center min-h-[320px] md:min-h-[380px]">
            <img src="https://wildmarkresort.com/images/testimonials3.webp" alt="TripAdvisor Travellers' Choice Award 2022"
              class="w-full h-auto max-w-[280px] object-contain award-image">
          </div>
        </div>
        ...
        <div class="award-card group" data-aos="fade-up"    style="background-color: #39DCA1;border-radius: 9px;">
          <div
            ...
            <img src="https://wildmarkresort.com/images/testimonials4.webp" alt="TripAdvisor Travelers' Choice Award 2025"
