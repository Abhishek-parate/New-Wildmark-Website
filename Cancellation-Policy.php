    ...
    <div class="space-y-4" data-aos="fade-up" data-aos-duration="1000">
      ...
      <div class="faq-item bg-neutral-900 border border-neutral-800 rounded-xl overflow-hidden">
        <button class="faq-question w-full text-left px-6 py-5 flex justify-between items-center hover:bg-neutral-800 transition">
          <span class="text-base md:text-lg font-serif text-white pr-4">What happens if I modify my booking within 35 days of arrival?</span>
          <svg class="faq-icon w-6 h-6 text-amber-500 transition-transform" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7" />
          </svg>
        </button>
        <div class="faq-answer max-h-0 overflow-hidden transition-all duration-300">
          <div class="px-6 py-5 bg-neutral-800/50 border-t border-neutral-700">
            <p class="text-gray-300">Any modification within 35 days is treated as a cancellation and charged as per policy.</p>
          </div>
        </div>
      </div>
      ...
      <div class="faq-item bg-neutral-900 border border-neutral-800 rounded-xl overflow-hidden">
        <button class="faq-question w-full text-left px-6 py-5 flex justify-between items-center hover:bg-neutral-800 transition">
          <span class="text-base md:text-lg font-serif text-white pr-4">How is the cancellation charge calculated?</span>
          <svg class="faq-icon w-6 h-6 text-amber-500 transition-transform" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7" />
          </svg>
        </button>
      ...
      <div class="faq-item bg-neutral-900 border border-neutral-800 rounded-xl overflow-hidden">
        <button class="faq-question w-full text-left px-6 py-5 flex justify-between items-center hover:bg-neutral-800 transition">
          <span class="text-base md:text-lg font-serif text-white pr-4">Are Christmas & New Year bookings refundable?</span>
          <svg class="faq-icon w-6 h-6 text-amber-500 transition-transform" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7" />
          </svg>
        </button>
        <div class="faq-answer max-h-0 overflow-hidden transition-all duration-300">
          <div class="px-6 py-5 bg-neutral-800/50 border-t border-neutral-700">
            <p class="text-gray-300">No, peak season bookings (Christmas, New Year, long weekends) are non-refundable.</p>
          </div>
        </div>
      </div>
      ...
      <div class="faq-item bg-neutral-900 border border-neutral-800 rounded-xl overflow-hidden">
        <button class="faq-question w-full text-left px-6 py-5 flex justify-between items-center hover:bg-neutral-800 transition">
          <span class="text-base md:text-lg font-serif text-white pr-4">What if there is a medical emergency?</span>
          <svg class="faq-icon w-6 h-6 text-amber-500 transition-transform" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7" />
          </svg>
        </button>
        <div class="faq-answer max-h-0 overflow-hidden transition-all duration-300">
          <div class="px-6 py-5 bg-neutral-800/50 border-t border-neutral-700">
            <p class="text-gray-300">In case of hospitalization, a 100% credit note is issued. No cash refunds.</p>
          </div>
        </div>
      </div>
      ...
      <div class="faq-item bg-neutral-900 border border-neutral-800 rounded-xl overflow-hidden">
        ...
        <div class="faq-answer max-h-0 overflow-hidden transition-all duration-300">
          <div class="px-6 py-5 bg-neutral-800/50 border-t border-neutral-700">
            <p class="text-gray-300">No refunds are provided for safari bookings as they are third-party services.</p>
          </div>
        </div>
      </div>
      ...
      <div class="faq-item bg-neutral-900 border border-neutral-800 rounded-xl overflow-hidden">
        ...
        <div class="faq-answer max-h-0 overflow-hidden transition-all duration-300">
          <div class="px-6 py-5 bg-neutral-800/50 border-t border-neutral-700">
            <p class="text-gray-300">A credit note is a future booking voucher issued instead of a cash refund.</p>
          </div>
        </div>
      </div>
