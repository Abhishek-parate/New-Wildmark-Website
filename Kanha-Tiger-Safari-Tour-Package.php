...
$pageTitle = "Kanha Tiger Safari Tour Package - Wildmark Resort Kanha";
...
<section class="py-8 md:py-12 bg-black">
    <div class="max-w-7xl mx-auto text-center px-4">
        <div
            class="inline-flex items-center gap-1 bg-amber-600/20 backdrop-blur-sm px-3 md:px-4 py-2 rounded-full mb-4">
    ...
    <div class="max-w-6xl mx-auto px-4 md:px-6">
        ...
        <div class="grid md:grid-cols-2 gap-8 md:gap-12">
            ...
            <div class="panel hidden" data-tab="superdeluxe">
                <img src="images/delux2.jpeg" class="rounded-xl w-full h-64 object-cover" alt="Super Deluxe" />
            </div>
            <div class="panel hidden" data-tab="superdeluxe">
            ...
            <div class="panel hidden" data-tab="family">
                <ul class="grid grid-cols-1 sm:grid-cols-1 gap-2 text-gray-300 text-sm mt-2 text-justify">
                    <li>
                        <i class="fa-solid fa-check icon-check mr-2 mb-2"></i><strong>Kanha Zone:</strong>This is the
                        most popular
                        safari
                    ...
                    <li>
                        <i class="fa-solid fa-check icon-check mr-2 mb-2"></i><strong>Kisli Zone:</strong>This zone is
                        known for
                        its rich
                    ...
                    <li>
                        <i class="fa-solid fa-check icon-check mr-2 mb-2"></i><strong>Sarhi Zone:</strong>This zone is
                        known for
                        its scenic
                    ...
                    <li>
                        <i class="fa-solid fa-check icon-check mr-2 mb-2"></i><strong>Mukki Zone:</strong>This zone is
                        relatively
                        less
...
<!-- FAQs Section - Kanha Tiger Safari Tour Package -->
    ...
    <div class="container mx-auto max-w-5xl px-4 md:px-6">
        <div class="text-center mb-12 md:mb-16">
            ...
            <p class="text-sm md:text-base text-gray-300 max-w-2xl mx-auto leading-relaxed" data-aos="fade-up"
                data-aos-delay="200">
                Everything you need to know about the Kanha Tiger Safari Tour Package - Our Most Comprehensive Wildlife
                Experience
            </p>
        </div>
        ...
        <div class="space-y-4 max-w-4xl mx-auto" data-aos="fade-up" data-aos-duration="1000">
            ...
            <div class="faq-item bg-black border border-neutral-800 rounded-xl overflow-hidden">
                <button
                    ...
                    <span class="text-base md:text-lg font-serif text-white pr-4">What makes the 3N/4D Kanha Tiger
                        Safari Package the ultimate wildlife experience?</span>
                ...
                <div class="faq-answer max-h-0 overflow-hidden transition-all duration-300 ease-in-out">
                    <div class="px-5 md:px-6 py-4 md:py-5 bg-neutral-800/50 border-t border-neutral-700">
                        <p class="text-sm md:text-base text-gray-300 leading-relaxed mb-3">
                            This is our MOST COMPREHENSIVE package featuring <strong>6 jungle safaris across ALL FOUR
                                zones</strong> of Kanha National Park:
                        </p>
                        <ul class="text-sm md:text-base text-gray-300 space-y-2 ml-4">
                            ...
                            <li class="flex items-start gap-2">
                                <span class="text-amber-500">•</span>
                                <span><strong>Day 2:</strong> Morning safari in Kanha + Afternoon safari in Kisli
                                    Zone</span>
                            </li>
                            <li class="flex items-start gap-2">
                                <span class="text-amber-500">•</span>
                                <span><strong>Day 3:</strong> Morning safari in Sarhi + Afternoon safari in Mukki
                                    Zone</span>
                            </li>
                            <li class="flex items-start gap-2">
                                <span class="text-amber-500">•</span>
                                <span><strong>Day 4:</strong> Final morning safari in Mukki Zone</span>
                            </li>
                        </ul>
                        <p class="text-sm md:text-base text-gray-300 leading-relaxed mt-3">
                            <strong>Why this is special:</strong> You experience EVERY major zone of Kanha, maximizing
                            your chances of spotting tigers including famous ones like Junior Bajrang, Sunaina, and DB2
                            male, plus Barahsingha, leopards, sloth bears, and wild dogs!
                        </p>
                    </div>
                </div>
            </div>
            ...
            <div class="faq-item bg-black border border-neutral-800 rounded-xl overflow-hidden">
                <button
                    class="faq-question w-full text-left px-5 md:px-6 py-4 md:py-5 flex justify-between items-center hover:bg-neutral-800 transition">
                    <span class="text-base md:text-lg font-serif text-white pr-4">What is included in this 3N/4D premium
                        package?</span>
                    <svg class="faq-icon w-5 h-5 md:w-6 md:h-6 text-amber-500 flex-shrink-0 transition-transform duration-300"
                        fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7"></path>
                ...
                <div class="faq-answer max-h-0 overflow-hidden transition-all duration-300 ease-in-out">
                    <div class="px-5 md:px-6 py-4 md:py-5 bg-neutral-800/50 border-t border-neutral-700">
                        <p class="text-sm md:text-base text-gray-300 leading-relaxed mb-3">
                            Complete all-inclusive premium package:
                        </p>
                        <ul class="text-sm md:text-base text-gray-300 space-y-2 ml-4">
                            <li class="flex items-start gap-2">
                                <span class="text-amber-500">•</span>
                                <span><strong>Accommodation:</strong> 3 nights premium stay at Wildmark Resort
                                    Kanha</span>
                            </li>
                            <li class="flex items-start gap-2">
                                <span class="text-amber-500">•</span>
                                <span><strong>Meals:</strong> All meals - Breakfast (including 3 safari breakfasts),
                                    Lunch, Hi-tea, and Dinner for entire duration</span>
                            </li>
                            <li class="flex items-start gap-2">
                                <span class="text-amber-500">•</span>
                                <span><strong>Safaris:</strong> 6 jungle safaris covering all 4 zones - Kanha (2
                                    safaris), Kisli (1), Sarhi (1), Mukki (2)</span>
                            </li>
                            <li class="flex items-start gap-2">
                                <span class="text-amber-500">•</span>
                                <span><strong>Water:</strong> Daily one bottle of mineral water (500ml) per guest at
                                    resort</span>
                            </li>
                            <li class="flex items-start gap-2">
                                <span class="text-amber-500">•</span>
                                <span><strong>Transfers:</strong> Complete pick-up and drop from/to Jabalpur Airport or
            ...
            <div class="faq-item bg-black border border-neutral-800 rounded-xl overflow-hidden">
                <button
                    class="faq-question w-full text-left px-5 md:px-6 py-4 md:py-5 flex justify-between items-center hover:bg-neutral-800 transition">
                    <span class="text-base md:text-lg font-serif text-white pr-4">What are the unique features of all
                        FOUR zones covered?</span>
                    <svg class="faq-icon w-5 h-5 md:w-6 md:h-6 text-amber-500 flex-shrink-0 transition-transform duration-300"
                        fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7"></path>
                    </svg>
                ...
                <div class="faq-answer max-h-0 overflow-hidden transition-all duration-300 ease-in-out">
                    <div class="px-5 md:px-6 py-4 md:py-5 bg-neutral-800/50 border-t border-neutral-700">
                        <p class="text-sm md:text-base text-gray-300 leading-relaxed mb-3">
                            Each zone offers completely unique wildlife and landscape experiences:
                        </p>
                        <ul class="text-sm md:text-base text-gray-300 space-y-3 ml-4">
                            <li class="flex items-start gap-2">
                                <span class="text-amber-500">•</span>
                                <span><strong>Kanha Zone (2 safaris):</strong> Most popular zone! Scenic beauty with
                                    high tiger sighting probability including iconic tigers Junior Bajrang and his
                                    partner Sunaina. Excellent for Barahsingha (swamp deer) sightings.</span>
                            </li>
                            <li class="flex items-start gap-2">
                                <span class="text-amber-500">•</span>
                                <span><strong>Kisli Zone (1 safari):</strong> Rich flora and fauna, home to Barahsingha
                                    (state animal of MP). Famous for iconic Tiger DB2 male. Paradise for birdwatching
                                    enthusiasts.</span>
                            </li>
                            <li class="flex items-start gap-2">
                                <span class="text-amber-500">•</span>
                                <span><strong>Sarhi Zone (1 safari):</strong> Known for breathtaking scenic beauty.
                                    Prime territory for sloth bear sightings, wild dogs (dholes), leopards, and
                                    exceptional birdwatching opportunities.</span>
                            </li>
                            <li class="flex items-start gap-2">
                                <span class="text-amber-500">•</span>
                                <span><strong>Mukki Zone (2 safaris):</strong> Relatively less crowded with rugged
                                    terrain. VERY HIGH chances of tiger and leopard sightings. Perfect for serious
                                    wildlife photographers.</span>
                            </li>
                        </ul>
                    </div>
                </div>
            ...
            <div class="faq-item bg-black border border-neutral-800 rounded-xl overflow-hidden">
                <button
                    class="faq-question w-full text-left px-5 md:px-6 py-4 md:py-5 flex justify-between items-center hover:bg-neutral-800 transition">
                    <span class="text-base md:text-lg font-serif text-white pr-4">What is the cancellation and refund
                        policy?</span>
                    <svg class="faq-icon w-5 h-5 md:w-6 md:h-6 text-amber-500 flex-shrink-0 transition-transform duration-300"
                        fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7"></path>
                ...
                <div class="faq-answer max-h-0 overflow-hidden transition-all duration-300 ease-in-out">
                    <div class="px-5 md:px-6 py-4 md:py-5 bg-neutral-800/50 border-t border-neutral-700">
                        <ul class="text-sm md:text-base text-gray-300 space-y-2 ml-4">
                            <li class="flex items-start gap-2">
                                <span class="text-amber-500">•</span>
                                <span><strong>Safari Bookings:</strong> No refund on any of the 6 safari bookings
                                    (package deal with forest department)</span>
                            </li>
                            <li class="flex items-start gap-2">
                                <span class="text-amber-500">•</span>
                            ...
                            <li class="flex items-start gap-2">
                                <span class="text-amber-500">•</span>
                                <span><strong>Within 15 Days:</strong> Zero refund</span>
                            </li>
                            <li class="flex items-start gap-2">
                                <span class="text-amber-500">•</span>
                                <span><strong>Payment:</strong> 100% advance payment required for booking
                                    confirmation</span>
                            </li>
                        </ul>
                    </div>
            ...
            <div class="faq-item bg-black border border-neutral-800 rounded-xl overflow-hidden">
                <button
                    class="faq-question w-full text-left px-5 md:px-6 py-4 md:py-5 flex justify-between items-center hover:bg-neutral-800 transition">
                    <span class="text-base md:text-lg font-serif text-white pr-4">Why choose this 3N/4D package over
                        shorter packages?</span>
                    <svg class="faq-icon w-5 h-5 md:w-6 md:h-6 text-amber-500 flex-shrink-0 transition-transform duration-300"
                        fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7"></path>
                    </svg>
                ...
                <div class="faq-answer max-h-0 overflow-hidden transition-all duration-300 ease-in-out">
                    <div class="px-5 md:px-6 py-4 md:py-5 bg-neutral-800/50 border-t border-neutral-700">
                        <p class="text-sm md:text-base text-gray-300 leading-relaxed mb-3">
                            Choose this package if you want the ULTIMATE Kanha experience:
                        </p>
                        <ul class="text-sm md:text-base text-gray-300 space-y-2 ml-4">
                            <li class="flex items-start gap-2">
                                <span class="text-amber-500">•</span>
                                <span><strong>Complete Coverage:</strong> Only package covering ALL 4 zones (Kanha,
                                    Kisli, Sarhi, Mukki)</span>
                            </li>
                            <li class="flex items-start gap-2">
                                <span class="text-amber-500">•</span>
                                <span><strong>Maximum Safaris:</strong> 6 safaris vs 2-4 in shorter packages = 3x more
                                    wildlife opportunities</span>
                            </li>
                            <li class="flex items-start gap-2">
                                <span class="text-amber-500">•</span>
                                <span><strong>Best Value:</strong> More safaris per day = better value for money
                                    overall</span>
                            </li>
                            <li class="flex items-start gap-2">
                                <span class="text-amber-500">•</span>
                                <span><strong>For Serious Enthusiasts:</strong> Wildlife photographers, hardcore nature
                                    lovers, once-in-a-lifetime trip planners</span>
                            </li>
                            <li class="flex items-start gap-2">
                                <span class="text-amber-500">•</span>
                                <span><strong>Immersive Experience:</strong> Truly immerse yourself in Kanha's
                                    wilderness over 4 full days</span>
                            </li>
                        </ul>
                        <p class="text-sm md:text-base text-gray-300 leading-relaxed mt-3">
                            <strong>Compare:</strong> Our 1N/2D (1 safari), 2N/3D Safari (2 safaris), 2N/3D Kisli (4
                            safaris) vs THIS package (6 safaris + ALL zones).
                        </p>
                    </div>
                </div>
            </div>
