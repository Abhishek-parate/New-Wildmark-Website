...
<header class="relative h-[50vh] md:h-[60vh] lg:h-[70vh] flex items-end"
    style="background: url('https://wildmarkresort.com/images/webp/ktsptb1.webp') center/cover no-repeat">
    ...
    <div class="max-w-6xl mx-auto px-4 md:px-6">
        ...
        <div class="grid md:grid-cols-2 gap-8 md:gap-12">
            ...
            <div class="panel" data-tab="machaan">
                <img src="https://wildmarkresort.com/images/webp/ktstpi.webp" class="rounded-xl w-full h-64 object-cover" alt="Machaan" />
            </div>
            <div class="panel" data-tab="machaan">
            ...
            <div class="panel hidden" data-tab="superdeluxe">
                <img src="https://wildmarkresort.com/images/webp/ktstpe.webp" class="rounded-xl w-full h-64 object-cover" alt="Super Deluxe" />
            </div>
            <div class="panel hidden" data-tab="superdeluxe">
            ...
            <div class="panel hidden" data-tab="family">
                <img src="https://wildmarkresort.com/images/webp/ktsptz.webp" class="rounded-xl w-full h-64 object-cover" alt="Family" />
            </div>
            <div class="panel hidden" data-tab="family">
                <ul class="grid grid-cols-1 sm:grid-cols-1 gap-2 text-gray-300 text-sm mt-2 text-justify">
                    <li><i class="fa-solid fa-check icon-check mr-2 mb-2"></i><strong>Kanha Zone:</strong>This is the most popular safari zone and covers a large part of the core area. It is known for its scenic beauty and high chances of spotting tigers, Barahsingha and other wildlife. Iconic Tiger is Junior Bajrang and his partner Sunaina.</li>
                    <li><i class="fa-solid fa-check icon-check mr-2 mb-2"></i><strong>Kisli Zone:</strong>This zone is known for its rich flora and fauna, including the Barahsingha, which is the state animal of Madhya Pradesh. It is also a great place for birdwatching. Iconic Tiger is DB2 male.</li>
                    ...
                    <li><i class="fa-solid fa-check icon-check mr-2 mb-2"></i><strong>Mukki Zone:</strong>This zone is relatively less crowded and is known for its rugged terrain and high chances of spotting tigers and leopards.</li>
                </ul>
            </div>
        </div>
    </div>
        ...
        <div class="space-y-10">
            ...
            <div class="grid md:grid-cols-12 gap-6 items-center">
                <div class="md:col-span-6 flex gap-3">
                    <img class="w-1/2 h-32 md:h-40 object-cover rounded-lg" src="https://wildmarkresort.com/images/webp/ktpe.webp" alt="Day 1" />
                    <img class="w-1/2 h-32 md:h-40 object-cover rounded-lg" src="https://wildmarkresort.com/images/webp/ktstpd1.webp" alt="Day 1" />
                </div>
            ...
            <div class="grid md:grid-cols-12 gap-6 items-center">
                <div class="md:col-span-6 md:order-2">
                    <img class="w-full h-32 md:h-40 object-cover rounded-lg" src="https://wildmarkresort.com/images/webp/ktpd2.webp" alt="Day 2" />
                </div>
            ...
            <div class="grid md:grid-cols-12 gap-6 items-center">
                <div class="md:col-span-6 flex gap-3">
                    <img class="w-1/2 h-32 md:h-40 object-cover rounded-lg" src="https://wildmarkresort.com/images/webp/ktptc.webp" alt="Day 3" />
                    <img class="w-1/2 h-32 md:h-40 object-cover rounded-lg" src="https://wildmarkresort.com/images/webp/ktprp.webp" alt="Day 3" />
                </div>
                <div class="md:col-span-6">
                    ...
                    <ul class="grid grid-cols-1 sm:grid-cols-1 gap-2 text-gray-300 text-sm">
                        ...
                        <li><i class="fa-solid fa-check icon-check mr-2 mb-2"></i>Come back relax in the pool.</li>
                        <li><i class="fa-solid fa-check icon-check mr-2 mb-2"></i>Lunch will be served by 1 PM.</li>
                        <li><i class="fa-solid fa-check icon-check mr-2 mb-2"></i>Time for afternoon safari in Mukki Core Zone.</li>
                        <li><i class="fa-solid fa-check icon-check mr-2 mb-2"></i>After coming back time for Hi tea.</li>
                        <li><i class="fa-solid fa-check icon-check mr-2 mb-2"></i>Dinner will be served by 8.30 PM</li>
                        <li><i class="fa-solid fa-check icon-check mr-2 mb-2"></i>Time to go for bed.</li>
                    </ul>
            ...
            <div class="grid md:grid-cols-12 gap-6 items-center">
                <div class="md:col-span-6">
                    ...
                    <ul class="grid grid-cols-1 sm:grid-cols-1 gap-2 text-gray-300 text-sm">
                        <li><i class="fa-solid fa-check icon-check mr-2 mb-2"></i>Morning safari in Mukki Core Zone.</li>
                        <li><i class="fa-solid fa-check icon-check mr-2 mb-2"></i>Breakfast will be served in Safari.</li>
                ...
                <div class="md:col-span-6 md:order-2">
                    <img class="w-full h-32 md:h-40 object-cover rounded-lg" src="https://wildmarkresort.com/images/webp/ktstpd4.webp" alt="Day 4" />
                </div>
            </div>
        </div>
    </div>
        ...
        <div>
            <div class="experience-panel-a" data-tab-a="curated">
                <div class="grid md:grid-cols-2 gap-8 items-center">
                    <img src="https://wildmarkresort.com/images/webp/ktstptc.webp" class="rounded-xl w-full h-64 object-cover" alt="Payment" />
                    <div>
            ...
            <div class="experience-panel-a hidden" data-tab-a="dining">
                <div class="grid md:grid-cols-2 gap-8 items-center">
                    <img src="https://wildmarkresort.com/images/webp/ktsptrp.webp" class="rounded-xl w-full h-64 object-cover" alt="Cancellation" />
                    <div>
            ...
            <div class="swiper packageSwiper relative">
                <div class="swiper-wrapper">
                    ...
                    <div class="swiper-slide">
                        <div class="bg-neutral-900 rounded-xl overflow-hidden group hover:shadow-2xl hover:shadow-amber-500/10 transition-all duration-300 h-full flex flex-col">
                            <div class="relative overflow-hidden h-56 flex-shrink-0">
                                <img src="https://wildmarkresort.com/images/webp/ktpdd1.webp" class="w-full h-full object-cover group-hover:scale-110 transition-transform duration-500" alt="Kanha Package" />
                            </div>
                            <div class="p-6 flex flex-col flex-1">
                                <div class="flex items-center gap-2 mb-3">
                                    <div class="flex gap-1">
                                        <i class="fas fa-star text-[#8E1616]  text-xs"></i><i class="fas fa-star text-[#8E1616] text-xs"></i><i class="fas fa-star  text-xs text-[#8E1616] "></i><i class="fas fa-star text-[#8E1616]  text-xs"></i><i class="fas fa-star text-xs text-[#8E1616] "></i>
                                    </div>
                    ...
                    <div class="swiper-slide">
                        <div class="bg-neutral-900 rounded-xl overflow-hidden group hover:shadow-2xl hover:shadow-amber-500/10 transition-all duration-300 h-full flex flex-col">
                            <div class="relative overflow-hidden h-56 flex-shrink-0">
                                <img src="https://wildmarkresort.com/images/webp/mxtpb.webp" class="w-full h-full object-cover group-hover:scale-110 transition-transform duration-500" alt="Kanha Package" />
                            </div>
                            <div class="p-6 flex flex-col flex-1">
                                <div class="flex items-center gap-2 mb-3">
                                    <div class="flex gap-1">
                                        <i class="fas fa-star text-[#8E1616] text-xs"></i><i class="fas fa-star text-[#8E1616] text-xs"></i><i class="fas fa-star text-[#8E1616] text-xs"></i><i class="fas fa-star text-[#8E1616] text-xs"></i><i class="fas fa-star text-[#8E1616] text-xs"></i>
                                    </div>
                                    <span class="text-xs text-gray-400">(4.9/5)</span>
                                </div>
                                ...
                                <div class="flex items-center gap-4 text-xs text-gray-400 mt-auto">
                                    <div class="flex items-center gap-1"><i class="fa-solid fa-clock text-[#8E1616] "></i><span>2N/3D</span></div>
                                    <div class="flex items-center gap-1"><i class="fa-solid fa-paw"></i><span>4 Safaris</span></div>
                    ...
                    <div class="swiper-slide">
                        <div class="bg-neutral-900 rounded-xl overflow-hidden group hover:shadow-2xl hover:shadow-amber-500/10 transition-all duration-300 h-full flex flex-col">
                            <div class="relative overflow-hidden h-56 flex-shrink-0">
                                <img src="https://wildmarkresort.com/images/webp/kktpb.webp" class="w-full h-full object-cover group-hover:scale-110 transition-transform duration-500" alt="Kanha Package" />
                            </div>
                            <div class="p-6 flex flex-col flex-1">
                                <div class="flex items-center gap-2 mb-3">
                                    <div class="flex gap-1">
                                ...
                                <p class="text-gray-400 text-sm mb-4 line-clamp-2 flex-1">Kanha Kisli tour Package – Kanha National Park of Madhya Pradesh was...</p>
                                <div class="flex items-center gap-4 text-xs text-gray-400 mt-auto">
                                    <div class="flex items-center gap-1"><i class="fa-solid fa-clock text-[#8E1616] "></i><span>2N/3D</span></div>
                                    <div class="flex items-center gap-1"><i class="fa-solid fa-paw text-[#8E1616] "></i><span>4 Safaris</span></div>
                                    <a href="https://wildmarkresort.com/kanha-kisli-tour-package/" class="ml-auto bg-amber-600 hover:bg-amber-700 px-5 py-2 text-sm rounded transition text-white">View Details</a>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="swiper-slide">
                        <div class="bg-neutral-900 rounded-xl overflow-hidden group hover:shadow-2xl hover:shadow-amber-500/10 transition-all duration-300 h-full flex flex-col">
                            <div class="relative overflow-hidden h-56 flex-shrink-0">
                                <img src="https://wildmarkresort.com/images/webp/ktpb.webp" class="w-full h-full object-cover group-hover:scale-110 transition-transform duration-500" alt="Kanha Package" />
                            </div>
                            <div class="p-6 flex flex-col flex-1">
                                <div class="flex items-center gap-2 mb-3">
                                    <div class="flex gap-1">
...
<section class="py-12 md:py-20 px-4 md:px-6 bg-black awards-section overflow-hidden">
    <div class="container mx-auto max-w-7xl">
        <div class="text-center mb-10 md:mb-16">
            ...
            <p class="text-sm md:text-base text-gray-300 max-w-4xl mx-auto mb-2 md:mb-3 leading-relaxed" data-aos="fade-up" data-aos-delay="200">Honored to receive Travellers' Choice Awards from TripAdvisor for our exceptional hospitality</p>
        </div>
...
<section class="py-12 md:py-20 px-4 md:px-6 bg-neutral-900">
  <div class="mx-auto w-full" style="max-width: 1280px; padding: 0 24px;">
    <div class="text-center mb-10 md:mb-14">
      ...
      <p class="text-sm md:text-base text-gray-300 max-w-3xl mx-auto" data-aos="fade-up" data-aos-delay="200">Everything you need to know about Wildmark Resort — Best Resort in Kanha near Khatiya Gate</p>
    </div>
