...
/* Itinerary section */
#itinerary { background-color: var(--bg1) !important; }
#itinerary h2, #itinerary h3 { color: var(--text2) !important; }
#itinerary .text-gray-300 { color: var(--text1) !important; }

/* Payment Terms section */
#experiencesA { background-color: var(--bg2) !important; }
        ...
        <div class="panel hidden" data-tab="family">
          <ul class="grid grid-cols-1 sm:grid-cols-1 gap-2 text-gray-300 text-sm mt-2 text-justify">
            <li>
              ...
              less crowded and is known for its rugged terrain and high chances of
