...
<style>
    ...
    .kanha-hero-bg.loaded { transform: scale(1); }
    .kanha-hero-overlay {
      position: absolute; inset: 0;
      background: linear-gradient(to top, rgba(0,0,0,.92) 0%, rgba(0,0,0,.45) 50%, rgba(0,0,0,.2) 100%);
    }
    .kanha-hero-content { position:relative; z-index:2; padding:0 2rem 4rem; max-width:860px; }
    ...
    .zone-card img { width:100%; height:100%; object-fit:cover; transition:transform .7s ease; }
    ...
    .zone-card:hover .zone-card-overlay { background: linear-gradient(to top, rgba(0,0,0,.94) 0%, rgba(0,0,0,.3) 60%); }
    .zone-card-content { position:absolute; bottom:0; left:0; right:0; padding:1.5rem; }
    .zone-badge {
      display: inline-block;
      background: #d97706;
      color: #fff;
    ...
    .activity-icon i { color: #1c1917; font-size: 1rem; }
    ...
    /* ── BREADCRUMB ── */
    .breadcrumb a { color: rgba(255,255,255,.5); font-size: .75rem; font-family:"Roboto Mono",monospace; }
    .breadcrumb a:hover { color: #f59e0b; }
    .breadcrumb span { color: rgba(255,255,255,.3); font-size:.75rem; margin:0 .4rem; }
    ...
    /* ── SEASON TABLE ── */
    .season-row { border-bottom:1px solid rgba(255,255,255,.06); }
    ...
    .badge-best { background:rgba(34,197,94,.15); color:#4ade80; border:1px solid rgba(34,197,94,.3); }
    .badge-good { background:rgba(245,158,11,.15); color:#fbbf24; border:1px solid rgba(245,158,11,.3); }
    .badge-closed { background:rgba(239,68,68,.1); color:#f87171; border:1px solid rgba(239,68,68,.2); }

    /* Accordion */
    .faq-item { border-bottom:1px solid rgba(255,255,255,.07); }
    .faq-question { cursor:pointer; padding:1.25rem 0; display:flex; justify-content:space-between; align-items:center; }
    ...
    <div class="grid lg:grid-cols-2 gap-12 md:gap-20 items-center mb-16">
      ...
      <div data-aos="fade-right" data-aos-duration="1000">
        ...
        <p class="text-gray-300 text-sm md:text-base leading-relaxed mb-5 text-justify">
          Land of Gonds, historically ruled by Gond Dynasty for centuries, before the British Colonial influence. Around 1862, rules were introduced to prevent cutting of valuable timbers of Sal & Teak Trees. Later in 1879 Kanha was declared as Reserve Forest, a Wildlife Sanctuary in 1933, Kanha National Park in 1955 and a Kanha Tiger Reserve in 1973 — it became one of the first areas under Tiger Project.
        </p>
        <p class="text-gray-300 text-sm md:text-base leading-relaxed mb-5 text-justify">
          The tribes of Gonds & Baiga inhabited the thick jungles of Kanha. Till today the reserve is occupied by these tribes.
        </p>
        <p class="text-gray-300 text-sm md:text-base leading-relaxed mb-5 text-justify">
          The Kanha National Park was formed by merging Halon & Banjar Sanctuaries in 1955 and later in 1973 the park became Kanha Tiger Reserve.
        </p>
        <p class="text-gray-300 text-sm md:text-base leading-relaxed mb-5 text-justify">
          Earlier, Kanha Tiger Reserve was called as <em style="color:#fbbf24;">Kanha–Kisli National Park</em>. It is one of the tiger reserves of India and the largest national park of the state of Madhya Pradesh. It covers a Core area of 940 km² in two districts of Mandla and Balaghat and the surrounding buffer area of 1,067 km². The park is famous for Royal Bengal tigers, Indian leopards, sloth bears, Barasingha and Dhole.
        </p>
        <p class="text-gray-300 text-sm md:text-base leading-relaxed text-justify">
          <strong style="color:#fbbf24;">Barasingha, the swamp deer,</strong> is the main attraction of Kanha Tiger Reserve.
        </p>
      </div>
    ...
    <div data-aos="fade-up">
      ...
      <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-4">
        ...
        <div class="gate-card text-center" data-aos="fade-up" data-aos-delay="100">
          <div style="width:52px;height:52px;background:linear-gradient(135deg,#fbbf24,#d97706);border-radius:50%;display:flex;align-items:center;justify-content:center;margin:0 auto 1rem;">
    ...
    <div class="container mx-auto">
      <div class="grid grid-cols-2 md:grid-cols-4 gap-0">
        <div class="stat-item text-center py-3 px-4">
          ...
          <div style="font-family:'Roboto Mono',monospace;font-size:.65rem;letter-spacing:.12em;color:rgba(255,255,255,.8);text-transform:uppercase;">Sq. Km Area</div>
        </div>
        <div class="stat-item text-center py-3 px-4">
          <div class="text-2xl md:text-3xl font-serif font-bold text-white">~60</div>
          <div style="font-family:'Roboto Mono',monospace;font-size:.65rem;letter-spacing:.12em;color:rgba(255,255,255,.8);text-transform:uppercase;">Royal Bengal Tigers</div>
        </div>
        <div class="stat-item text-center py-3 px-4">
          <div class="text-2xl md:text-3xl font-serif font-bold text-white">4</div>
          <div style="font-family:'Roboto Mono',monospace;font-size:.65rem;letter-spacing:.12em;color:rgba(255,255,255,.8);text-transform:uppercase;">Safari Zones</div>
        </div>
        <div class="text-center py-3 px-4">
          <div class="text-2xl md:text-3xl font-serif font-bold text-white">1973</div>
          <div style="font-family:'Roboto Mono',monospace;font-size:.65rem;letter-spacing:.12em;color:rgba(255,255,255,.8);text-transform:uppercase;">Tiger Reserve Est.</div>
        </div>
      </div>
    </div>
  </div>
    ...
    <div class="container mx-auto max-w-7xl px-4 md:px-6">
      <div class="grid lg:grid-cols-2 gap-12 md:gap-20 items-center">
        ...
        <div data-aos="fade-right" data-aos-duration="1000">
          ...
          <p class="text-gray-300 text-sm md:text-base leading-relaxed mb-5 text-justify">
            Welcome to Kanha Tiger Reserve — also known as Kanha-Kisli National Park — the jewel of Madhya Pradesh and Central India's largest national park. Established in 1955, it gained prestigious tiger reserve status in 1973, becoming a champion for tiger conservation under Project Tiger.
          </p>
          <p class="text-gray-300 text-sm md:text-base leading-relaxed mb-8 text-justify">
            Encompassing 940 sq. km across Mandla and Balaghat districts, this magnificent reserve sprawls across the Maikal hills of the Satpura range. Lush Sal forests, emerald meadows, and sparkling streams paint a breathtaking canvas — the very landscape that inspired Rudyard Kipling's <em style="color:#fbbf24;">The Jungle Book</em>.
          </p>
          <!-- Timeline -->
          <div class="space-y-5">
    ...
    <div class="container mx-auto max-w-7xl px-4 md:px-6">
        ...
        <div class="grid lg:grid-cols-2 gap-12 md:gap-16 items-center">
          <div>
            ...
            <p class="text-gray-300 text-sm md:text-base leading-relaxed mb-6 text-justify">
              The scientific foundation of Kanha's management was significantly influenced by research conducted by George Schaller, whose landmark work helped refine predator-prey understanding here. The core zone helps understand the Schaller Hide research site, Shravan Tal (a water-dependent wildlife zone), and Bison Road - a major corridor for tiger and Indian gaur movements.. Thus Kanha Core zone is rich in Tiger & Sloth Bear sightings on the safaris. 
            </p>
            <div class="flex flex-wrap gap-2">
              <span style="background:rgba(245,158,11,0.12);border:1px solid rgba(245,158,11,0.3);color:#fbbf24;font-size:0.7rem;padding:0.3rem 0.8rem;border-radius:999px;font-family:'Roboto Mono',monospace;">Tiger</span>
              <span style="background:rgba(245,158,11,0.12);border:1px solid rgba(245,158,11,0.3);color:#fbbf24;font-size:0.7rem;padding:0.3rem 0.8rem;border-radius:999px;font-family:'Roboto Mono',monospace;">Sloth Bear</span>
              <span style="background:rgba(245,158,11,0.12);border:1px solid rgba(245,158,11,0.3);color:#fbbf24;font-size:0.7rem;padding:0.3rem 0.8rem;border-radius:999px;font-family:'Roboto Mono',monospace;">Barasingha</span>
              <span style="background:rgba(245,158,11,0.12);border:1px solid rgba(245,158,11,0.3);color:#fbbf24;font-size:0.7rem;padding:0.3rem 0.8rem;border-radius:999px;font-family:'Roboto Mono',monospace;">Indian Gaur</span>
            </div>
          </div>
          <div>
            <div class="relative">
              <div style="position:absolute;top:16px;left:16px;right:-16px;bottom:-16px;border:1px solid rgba(245,158,11,0.25);border-radius:1rem;z-index:0;"></div>
              <img src="images/card1.webp" alt="Kanha Core Zone"
                class="w-full h-[380px] md:h-[460px] object-cover rounded-2xl shadow-2xl" style="position:relative;z-index:1;"/>
              <div style="position:absolute;bottom:20px;left:20px;z-index:2;background:rgba(0,0,0,0.75);backdrop-filter:blur(8px);border-left:3px solid #f59e0b;padding:0.5rem 1rem;">
                <p style="color:#f59e0b;font-size:0.65rem;letter-spacing:0.15em;font-family:'Roboto Mono',monospace;margin:0;text-transform:uppercase;">Core Zone</p>
                <p style="color:rgba(255,255,255,0.7);font-size:0.6rem;margin:0;font-family:'Roboto Mono',monospace;">Rich in Tiger & Sloth Bear Sightings</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <div id="tab-kisli" class="hidden" data-aos="fade-up">
        <div class="grid lg:grid-cols-2 gap-12 md:gap-16 items-center">
          <div>
            <div class="relative">
              <div style="position:absolute;top:16px;right:16px;left:-16px;bottom:-16px;border:1px solid rgba(245,158,11,0.25);border-radius:1rem;z-index:0;"></div>
              <img src="images/card2.webp" alt="Kisli Zone"
                class="w-full h-[380px] md:h-[460px] object-cover rounded-2xl shadow-2xl" style="position:relative;z-index:1;"/>
              <div style="position:absolute;bottom:20px;right:20px;z-index:2;background:rgba(0,0,0,0.75);backdrop-filter:blur(8px);border-left:3px solid #f59e0b;padding:0.5rem 1rem;">
                <p style="color:#f59e0b;font-size:0.65rem;letter-spacing:0.15em;font-family:'Roboto Mono',monospace;margin:0;text-transform:uppercase;">Core Zone</p>
                <p style="color:rgba(255,255,255,0.7);font-size:0.6rem;margin:0;font-family:'Roboto Mono',monospace;">Classic Heartland of Kanha</p>
              </div>
            </div>
          </div>
          <div>
            ...
            <p class="text-gray-300 text-sm md:text-base leading-relaxed mb-5 text-justify">
              Kisli zone is one of the oldest zones for tourists in Kanha Tiger Reserve. The landscapes feature larger open grasslands with dense Sal Forests, bamboo thickets, and seasonal water bodies that play a major role for Royal Bengal Tiger sightings and offer a balanced and complete safari experience for tourists.
            </p>
            <p class="text-gray-300 text-sm md:text-base leading-relaxed mb-5 text-justify">
            ...
            <div class="flex flex-wrap gap-2">
              <span style="background:rgba(245,158,11,0.12);border:1px solid rgba(245,158,11,0.3);color:#fbbf24;font-size:0.7rem;padding:0.3rem 0.8rem;border-radius:999px;font-family:'Roboto Mono',monospace;">Tiger</span>
              <span style="background:rgba(245,158,11,0.12);border:1px solid rgba(245,158,11,0.3);color:#fbbf24;font-size:0.7rem;padding:0.3rem 0.8rem;border-radius:999px;font-family:'Roboto Mono',monospace;">Gaur</span>
              <span style="background:rgba(245,158,11,0.12);border:1px solid rgba(245,158,11,0.3);color:#fbbf24;font-size:0.7rem;padding:0.3rem 0.8rem;border-radius:999px;font-family:'Roboto Mono',monospace;">Sloth Bear</span>
              <span style="background:rgba(245,158,11,0.12);border:1px solid rgba(245,158,11,0.3);color:#fbbf24;font-size:0.7rem;padding:0.3rem 0.8rem;border-radius:999px;font-family:'Roboto Mono',monospace;">Photographer's Paradise</span>
            </div>
          </div>
        </div>
      </div>
      ...
      <div id="tab-mukki" class="hidden" data-aos="fade-up">
        <div class="grid lg:grid-cols-2 gap-12 md:gap-16 items-center">
          <div>
            ...
            <p class="text-gray-300 text-sm md:text-base leading-relaxed mb-6 text-justify">
              The zone is characterized by its dense sal, bamboo, and grassland ecosystems. Heart-pounding tiger encounters in pristine settings make Mukki one of the most exciting zones for wildlife enthusiasts and photographers.
            </p>
            <div class="flex flex-wrap gap-2">
              <span style="background:rgba(245,158,11,0.12);border:1px solid rgba(245,158,11,0.3);color:#fbbf24;font-size:0.7rem;padding:0.3rem 0.8rem;border-radius:999px;font-family:'Roboto Mono',monospace;">Tiger</span>
              <span style="background:rgba(245,158,11,0.12);border:1px solid rgba(245,158,11,0.3);color:#fbbf24;font-size:0.7rem;padding:0.3rem 0.8rem;border-radius:999px;font-family:'Roboto Mono',monospace;">Barasingha</span>
              <span style="background:rgba(245,158,11,0.12);border:1px solid rgba(245,158,11,0.3);color:#fbbf24;font-size:0.7rem;padding:0.3rem 0.8rem;border-radius:999px;font-family:'Roboto Mono',monospace;">Leopard</span>
              <span style="background:rgba(245,158,11,0.12);border:1px solid rgba(245,158,11,0.3);color:#fbbf24;font-size:0.7rem;padding:0.3rem 0.8rem;border-radius:999px;font-family:'Roboto Mono',monospace;">Wild Dog</span>
              <span style="background:rgba(245,158,11,0.12);border:1px solid rgba(245,158,11,0.3);color:#fbbf24;font-size:0.7rem;padding:0.3rem 0.8rem;border-radius:999px;font-family:'Roboto Mono',monospace;">Migratory Birds</span>
            </div>
          </div>
          <div>
            <div class="relative">
              ...
              <div style="position:absolute;bottom:20px;left:20px;z-index:2;background:rgba(0,0,0,0.75);backdrop-filter:blur(8px);border-left:3px solid #f59e0b;padding:0.5rem 1rem;">
                <p style="color:#f59e0b;font-size:0.65rem;letter-spacing:0.15em;font-family:'Roboto Mono',monospace;margin:0;text-transform:uppercase;">Core Zone</p>
                <p style="color:rgba(255,255,255,0.7);font-size:0.6rem;margin:0;font-family:'Roboto Mono',monospace;">Dense Forest Wilderness</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="grid lg:grid-cols-2 gap-12 md:gap-16 items-center">
          <div>
            <div class="relative">
              ...
              <div style="position:absolute;bottom:20px;right:20px;z-index:2;background:rgba(0,0,0,0.75);backdrop-filter:blur(8px);border-left:3px solid #f59e0b;padding:0.5rem 1rem;">
                <p style="color:#f59e0b;font-size:0.65rem;letter-spacing:0.15em;font-family:'Roboto Mono',monospace;margin:0;text-transform:uppercase;">Core Zone</p>
                <p style="color:rgba(255,255,255,0.7);font-size:0.6rem;margin:0;font-family:'Roboto Mono',monospace;">Quiet Wilderness Experience</p>
              </div>
            </div>
          </div>
          <div>
            ...
            <p class="text-gray-300 text-sm md:text-base leading-relaxed mb-6 text-justify">
              Capture dramatic golden hour landscapes without tourist disturbance. The zone is ideal for wildlife lovers and photographers seeking focused habitat understanding, ethical wildlife tracking, and premium field guidance to experience patience-driven sightings and authentic jungle silence that elevates safari beyond tourism into a true wildlife experience.
            </p>
            <div class="flex flex-wrap gap-2">
              <span style="background:rgba(245,158,11,0.12);border:1px solid rgba(245,158,11,0.3);color:#fbbf24;font-size:0.7rem;padding:0.3rem 0.8rem;border-radius:999px;font-family:'Roboto Mono',monospace;">Barasingha</span>
              <span style="background:rgba(245,158,11,0.12);border:1px solid rgba(245,158,11,0.3);color:#fbbf24;font-size:0.7rem;padding:0.3rem 0.8rem;border-radius:999px;font-family:'Roboto Mono',monospace;">Tiger</span>
              <span style="background:rgba(245,158,11,0.12);border:1px solid rgba(245,158,11,0.3);color:#fbbf24;font-size:0.7rem;padding:0.3rem 0.8rem;border-radius:999px;font-family:'Roboto Mono',monospace;">Sambar</span>
              <span style="background:rgba(245,158,11,0.12);border:1px solid rgba(245,158,11,0.3);color:#fbbf24;font-size:0.7rem;padding:0.3rem 0.8rem;border-radius:999px;font-family:'Roboto Mono',monospace;">Less Crowded</span>
            </div>
          </div>
        </div>
      </div>
      ...
      <div id="tab-khatia" class="hidden" data-aos="fade-up">
        <div class="grid lg:grid-cols-2 gap-12 md:gap-16 items-center">
          <div>
            ...
            <p class="text-gray-300 text-sm md:text-base leading-relaxed mb-5 text-justify">
              <strong style="color:#fbbf24;">Wildmark Resort is closest to this gate - less than 1 km away!</strong> This makes it the ideal starting point for most visitors, allowing you to be among the first to enter at 6:00 AM and return quickly for breakfast and relaxation between safaris.
            </p>
            <p class="text-gray-300 text-sm md:text-base leading-relaxed mb-6 text-justify">
              The gate provides convenient access to the Kisli-Kanha tourism belt, making it the most popular choice for safari-goers. Its strategic location offers the best combination of accessibility and wildlife viewing opportunities.
            </p>
            <div class="flex flex-wrap gap-2">
              <span style="background:rgba(245,158,11,0.12);border:1px solid rgba(245,158,11,0.3);color:#fbbf24;font-size:0.7rem;padding:0.3rem 0.8rem;border-radius:999px;font-family:'Roboto Mono',monospace;">Main Entry Point</span>
              <span style="background:rgba(245,158,11,0.12);border:1px solid rgba(245,158,11,0.3);color:#fbbf24;font-size:0.7rem;padding:0.3rem 0.8rem;border-radius:999px;font-family:'Roboto Mono',monospace;">Kanha & Kisli Access</span>
              <span style="background:rgba(245,158,11,0.12);border:1px solid rgba(245,158,11,0.3);color:#fbbf24;font-size:0.7rem;padding:0.3rem 0.8rem;border-radius:999px;font-family:'Roboto Mono',monospace;">Wildmark Nearby</span>
            </div>
          </div>
          <div>
            <div class="relative">
              ...
              <img src="images/card1.webp" alt="Khatia Gate"
                class="w-full h-[380px] md:h-[460px] object-cover rounded-2xl shadow-2xl" style="position:relative;z-index:1;"/>
              <div style="position:absolute;bottom:20px;left:20px;z-index:2;background:rgba(0,0,0,0.75);backdrop-filter:blur(8px);border-left:3px solid #f59e0b;padding:0.5rem 1rem;">
                <p style="color:#f59e0b;font-size:0.65rem;letter-spacing:0.15em;font-family:'Roboto Mono',monospace;margin:0;text-transform:uppercase;">Entry Gate</p>
                <p style="color:rgba(255,255,255,0.7);font-size:0.6rem;margin:0;font-family:'Roboto Mono',monospace;">Most Famous & Accessible</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="grid lg:grid-cols-2 gap-12 md:gap-16 items-center">
          <div>
            <div class="relative">
              ...
              <div style="position:absolute;bottom:20px;right:20px;z-index:2;background:rgba(0,0,0,0.75);backdrop-filter:blur(8px);border-left:3px solid #f59e0b;padding:0.5rem 1rem;">
                <p style="color:#f59e0b;font-size:0.65rem;letter-spacing:0.15em;font-family:'Roboto Mono',monospace;margin:0;text-transform:uppercase;">Entry Gate</p>
                <p style="color:rgba(255,255,255,0.7);font-size:0.6rem;margin:0;font-family:'Roboto Mono',monospace;">Southern Access Point</p>
              </div>
            </div>
          </div>
          <div>
            ...
            <p class="text-gray-300 text-sm md:text-base leading-relaxed mb-5 text-justify">
              Mukki Entry Gate is far away from Khatiya Entry gate and provides access to the Mukki zone in the southern part of the reserve. This gate is known for its dense forest cover and excellent big cat sightings.
            </p>
            <p class="text-gray-300 text-sm md:text-base leading-relaxed mb-5 text-justify">
              The gate is best suited for dedicated wildlife photographers seeking immersive forest experiences. The Mukki zone accessed through this gate is renowned for incredible tiger encounters amidst pristine sal, bamboo, and grassland ecosystems.
            </p>
            <p class="text-gray-300 text-sm md:text-base leading-relaxed mb-6 text-justify">
              Due to numerous water bodies in the area, summer safaris through Mukki Gate offer exceptional wildlife viewing opportunities as animals gather near water sources. The zone also attracts many migratory birds, making it a paradise for birdwatchers.
            </p>
            <div class="flex flex-wrap gap-2">
              <span style="background:rgba(245,158,11,0.12);border:1px solid rgba(245,158,11,0.3);color:#fbbf24;font-size:0.7rem;padding:0.3rem 0.8rem;border-radius:999px;font-family:'Roboto Mono',monospace;">Dense Forest</span>
              <span style="background:rgba(245,158,11,0.12);border:1px solid rgba(245,158,11,0.3);color:#fbbf24;font-size:0.7rem;padding:0.3rem 0.8rem;border-radius:999px;font-family:'Roboto Mono',monospace;">Big Cat Sightings</span>
              <span style="background:rgba(245,158,11,0.12);border:1px solid rgba(245,158,11,0.3);color:#fbbf24;font-size:0.7rem;padding:0.3rem 0.8rem;border-radius:999px;font-family:'Roboto Mono',monospace;">Photography</span>
            </div>
          </div>
        </div>
      </div>
      ...
      <div id="tab-sarhi-gate" class="hidden" data-aos="fade-up">
        <div class="grid lg:grid-cols-2 gap-12 md:gap-16 items-center">
          <div>
            ...
            <p class="text-gray-300 text-sm md:text-base leading-relaxed mb-5 text-justify">
              Sarhi Entry Gate is far away from Khatiya Entry gate and provides entry to the Sarhi buffer zone. This gate offers a quieter, less-commercialized experience compared to other entry points.
            </p>
            <p class="text-gray-300 text-sm md:text-base leading-relaxed mb-5 text-justify">
              The zone is great for birdwatching and sighting the rare Barasingha - the state animal of Madhya Pradesh. Sarhi is perfect for those seeking authentic jungle silence and undisturbed wildlife encounters.
            </p>
            <p class="text-gray-300 text-sm md:text-base leading-relaxed mb-6 text-justify">
              With fewer safari vehicles in the zone, it becomes easier to track tigers and observe hard-ground Barasingha herds without tourist disturbance. The serene environment makes it ideal for wildlife lovers and photographers seeking a more intimate safari experience.
            </p>
            <div class="flex flex-wrap gap-2">
              <span style="background:rgba(245,158,11,0.12);border:1px solid rgba(245,158,11,0.3);color:#fbbf24;font-size:0.7rem;padding:0.3rem 0.8rem;border-radius:999px;font-family:'Roboto Mono',monospace;">Barasingha</span>
              <span style="background:rgba(245,158,11,0.12);border:1px solid rgba(245,158,11,0.3);color:#fbbf24;font-size:0.7rem;padding:0.3rem 0.8rem;border-radius:999px;font-family:'Roboto Mono',monospace;">Birdwatching</span>
              <span style="background:rgba(245,158,11,0.12);border:1px solid rgba(245,158,11,0.3);color:#fbbf24;font-size:0.7rem;padding:0.3rem 0.8rem;border-radius:999px;font-family:'Roboto Mono',monospace;">Less Crowded</span>
              <span style="background:rgba(245,158,11,0.12);border:1px solid rgba(245,158,11,0.3);color:#fbbf24;font-size:0.7rem;padding:0.3rem 0.8rem;border-radius:999px;font-family:'Roboto Mono',monospace;">Quiet Experience</span>
            </div>
          </div>
          <div>
            <div class="relative">
              ...
              <div style="position:absolute;bottom:20px;left:20px;z-index:2;background:rgba(0,0,0,0.75);backdrop-filter:blur(8px);border-left:3px solid #f59e0b;padding:0.5rem 1rem;">
                <p style="color:#f59e0b;font-size:0.65rem;letter-spacing:0.15em;font-family:'Roboto Mono',monospace;margin:0;text-transform:uppercase;">Entry Gate</p>
                <p style="color:rgba(255,255,255,0.7);font-size:0.6rem;margin:0;font-family:'Roboto Mono',monospace;">Peaceful Wilderness Entry</p>
              </div>
            </div>
          </div>
        </div>
          ...
          <div>
            <div class="relative">
              ...
              <img src="images/card2.webp" alt="Buffer Zones"
                class="w-full h-[380px] md:h-[460px] object-cover rounded-2xl shadow-2xl" style="position:relative;z-index:1;"/>
              <div style="position:absolute;bottom:20px;right:20px;z-index:2;background:rgba(0,0,0,0.75);backdrop-filter:blur(8px);border-left:3px solid #f59e0b;padding:0.5rem 1rem;">
                <p style="color:#f59e0b;font-size:0.65rem;letter-spacing:0.15em;font-family:'Roboto Mono',monospace;margin:0;text-transform:uppercase;">Buffer Zones</p>
                <p style="color:rgba(255,255,255,0.7);font-size:0.6rem;margin:0;font-family:'Roboto Mono',monospace;">Ecological Transition Landscapes</p>
              </div>
            </div>
          </div>
          <div>
            ...
            <p class="text-gray-300 text-sm md:text-base leading-relaxed mb-5 text-justify">
              The buffer zones of Kanha Tiger Reserve serve as ecological transitional landscapes surrounding the core zone areas. They play a vital role in wildlife dispersal and community-based conservation, functioning as tourist zones all around Kanha National Park.
            </p>
            <p class="text-gray-300 text-sm md:text-base leading-relaxed mb-5 text-justify">
              <strong style="color:#fbbf24;">Khatia Buffer Zone:</strong> Located near the Kisli-Kanha tourism belt with mixed sal forests and open patches. Supports strong tiger movement due to territorial extension from core zones. Leopard, sloth bear, and diverse birdlife are frequently observed.
            </p>
            <p class="text-gray-300 text-sm md:text-base leading-relaxed mb-5 text-justify">
              <strong style="color:#fbbf24;">Sijhora Buffer Zone:</strong> Features dense sal forest structure and emerging tiger territories. Common sightings of Indian Gaur and wild dogs with quieter drives and moderate vehicle density.
            </p>
            <p class="text-gray-300 text-sm md:text-base leading-relaxed mb-5 text-justify">
              <strong style="color:#fbbf24;">Garhi Buffer Zone:</strong> Includes forest-village interfaced landscapes with good birding opportunities. Tiger movement exists but sightings are less predictable, making it suitable for extended eco-tourism safaris.
            </p>
            <p class="text-gray-300 text-sm md:text-base leading-relaxed mb-6 text-justify">
              <strong style="color:#fbbf24;">Phen Buffer Zone (Phen Wildlife Sanctuary):</strong> Characterized by undulating terrain and mixed forests with rich wildlife. Lower tourist pressure with occasional tiger and leopard sightings, ideal for offbeat wildlife experiences.
            </p>
            <div class="flex flex-wrap gap-2">
              <span style="background:rgba(245,158,11,0.12);border:1px solid rgba(245,158,11,0.3);color:#fbbf24;font-size:0.7rem;padding:0.3rem 0.8rem;border-radius:999px;font-family:'Roboto Mono',monospace;">Wildlife Dispersal</span>
              <span style="background:rgba(245,158,11,0.12);border:1px solid rgba(245,158,11,0.3);color:#fbbf24;font-size:0.7rem;padding:0.3rem 0.8rem;border-radius:999px;font-family:'Roboto Mono',monospace;">Community Conservation</span>
              <span style="background:rgba(245,158,11,0.12);border:1px solid rgba(245,158,11,0.3);color:#fbbf24;font-size:0.7rem;padding:0.3rem 0.8rem;border-radius:999px;font-family:'Roboto Mono',monospace;">Eco-Tourism</span>
            </div>
          </div>
        </div>
      </div>
    ...
    <div class="container mx-auto max-w-7xl px-4 md:px-6">
      <div class="grid lg:grid-cols-2 gap-12 items-center">
        <div data-aos="fade-right" data-aos-duration="1000">
          ...
          <p class="text-gray-300 text-sm md:text-base leading-relaxed mb-8 text-justify">
            Kanha Tiger Reserve boasts a thriving population of approximately 60 Royal Bengal Tigers, thriving amidst the favourable weather and topography. The reserve's tigers are some of the most studied and photographed in the world — many have become legendary among wildlife enthusiasts.
          </p>
        ...
        <div class="relative h-[500px] md:h-[600px]" data-aos="fade-left" data-aos-duration="1000">
          ...
          <div style="position:absolute;bottom:1.5rem;left:1.5rem;right:1.5rem;background:rgba(0,0,0,.75);backdrop-filter:blur(10px);border:1px solid rgba(255,255,255,.1);border-radius:.75rem;padding:1rem 1.25rem;">
            <div class="flex items-center justify-between">
              <div>
                <p style="font-family:'Roboto Mono',monospace;font-size:.6rem;letter-spacing:.15em;color:#fbbf24;text-transform:uppercase;">Tiger Population</p>
                <p class="font-serif font-bold text-2xl text-white">~60 Tigers</p>
              </div>
              <div style="text-align:right;">
                <p style="font-family:'Roboto Mono',monospace;font-size:.6rem;letter-spacing:.15em;color:#fbbf24;text-transform:uppercase;">Conservation</p>
    ...
    <div id="tab-flora" data-aos="fade-up">
      <div class="grid lg:grid-cols-2 gap-12 md:gap-16 items-center">
        ...
        <div>
          ...
          <p class="text-gray-300 text-sm md:text-base leading-relaxed mb-6 text-justify">
            The park's vegetation includes significant species like Saja, Lendia, Dhawa, Tendu, Palas, Bija, and Mahua. There are other species of climbers, forbs, and grass. This is the unique experience and can be experienced only in Kanha Tiger Reserve during the Kanha Safari Tour.
          </p>
          <div class="flex flex-wrap gap-2">
            <span style="background:rgba(245,158,11,0.12);border:1px solid rgba(245,158,11,0.3);color:#fbbf24;font-size:0.7rem;padding:0.3rem 0.8rem;border-radius:999px;font-family:'Roboto Mono',monospace;">Sal Trees</span>
            <span style="background:rgba(245,158,11,0.12);border:1px solid rgba(245,158,11,0.3);color:#fbbf24;font-size:0.7rem;padding:0.3rem 0.8rem;border-radius:999px;font-family:'Roboto Mono',monospace;">Bamboo</span>
            <span style="background:rgba(245,158,11,0.12);border:1px solid rgba(245,158,11,0.3);color:#fbbf24;font-size:0.7rem;padding:0.3rem 0.8rem;border-radius:999px;font-family:'Roboto Mono',monospace;">Saja</span>
            <span style="background:rgba(245,158,11,0.12);border:1px solid rgba(245,158,11,0.3);color:#fbbf24;font-size:0.7rem;padding:0.3rem 0.8rem;border-radius:999px;font-family:'Roboto Mono',monospace;">Lendia</span>
            <span style="background:rgba(245,158,11,0.12);border:1px solid rgba(245,158,11,0.3);color:#fbbf24;font-size:0.7rem;padding:0.3rem 0.8rem;border-radius:999px;font-family:'Roboto Mono',monospace;">Dhawa</span>
            <span style="background:rgba(245,158,11,0.12);border:1px solid rgba(245,158,11,0.3);color:#fbbf24;font-size:0.7rem;padding:0.3rem 0.8rem;border-radius:999px;font-family:'Roboto Mono',monospace;">Tendu</span>
            <span style="background:rgba(245,158,11,0.12);border:1px solid rgba(245,158,11,0.3);color:#fbbf24;font-size:0.7rem;padding:0.3rem 0.8rem;border-radius:999px;font-family:'Roboto Mono',monospace;">Palas</span>
            <span style="background:rgba(245,158,11,0.12);border:1px solid rgba(245,158,11,0.3);color:#fbbf24;font-size:0.7rem;padding:0.3rem 0.8rem;border-radius:999px;font-family:'Roboto Mono',monospace;">Bija</span>
            <span style="background:rgba(245,158,11,0.12);border:1px solid rgba(245,158,11,0.3);color:#fbbf24;font-size:0.7rem;padding:0.3rem 0.8rem;border-radius:999px;font-family:'Roboto Mono',monospace;">Mahua</span>
          </div>
        </div>
        <!-- Right: Image -->
        <div>
          <div class="relative">
            ...
            <img src="images/card1.webp" alt="Kanha Flora"
              class="w-full h-[380px] md:h-[460px] object-cover rounded-2xl shadow-2xl" style="position:relative;z-index:1;"/>
            <div style="position:absolute;bottom:20px;left:20px;z-index:2;background:rgba(0,0,0,0.75);backdrop-filter:blur(8px);border-left:3px solid #f59e0b;padding:0.5rem 1rem;">
              <p style="color:#f59e0b;font-size:0.65rem;letter-spacing:0.15em;font-family:'Roboto Mono',monospace;margin:0;text-transform:uppercase;">Flora</p>
              <p style="color:rgba(255,255,255,0.7);font-size:0.6rem;margin:0;font-family:'Roboto Mono',monospace;">1000+ Flowering Plant Species</p>
            </div>
          </div>
        </div>
      </div>
    ...
    <div id="tab-fauna" class="hidden" data-aos="fade-up">
      <div class="grid lg:grid-cols-2 gap-12 md:gap-16 items-center">
        ...
        <div>
          <div class="relative">
            ...
            <img src="images/home3.webp" alt="Kanha Fauna"
              class="w-full h-[380px] md:h-[460px] object-cover rounded-2xl shadow-2xl" style="position:relative;z-index:1;"/>
            <div style="position:absolute;bottom:20px;right:20px;z-index:2;background:rgba(0,0,0,0.75);backdrop-filter:blur(8px);border-left:3px solid #f59e0b;padding:0.5rem 1rem;">
              <p style="color:#f59e0b;font-size:0.65rem;letter-spacing:0.15em;font-family:'Roboto Mono',monospace;margin:0;text-transform:uppercase;">Fauna</p>
              <p style="color:rgba(255,255,255,0.7);font-size:0.6rem;margin:0;font-family:'Roboto Mono',monospace;">300+ Bird Species · ~60 Royal Bengal Tigers</p>
            </div>
          </div>
        </div>
        <!-- Right: Content -->
        <div>
          ...
          <p class="text-gray-300 text-sm md:text-base leading-relaxed mb-5 text-justify">
            The main attraction of Kanha is <strong style="color:#fbbf24;">Barasingha</strong>, found only in Kanha Tiger Reserve. Kanha is famous for its Royal Bengal Tigers, Indian Leopards, Chital, Sambar, Barasingha, Gaur, Dhole, Sloth Bear, Indian Jackal, and Bengal Fox.
          </p>
          <p class="text-gray-300 text-sm md:text-base leading-relaxed mb-6 text-justify">
            Animals like Fox, Hyena, Jungle Cat, Civets, Porcupine, Ratel or Honey Badger, and Hares can be sighted outside the park confines. The reserve hosts around <strong style="color:#fbbf24;">300 species of birds</strong> including Indian Paradise Flycatcher, Black Ibis, Asian Green Bee-eater, Cattle Egret, Plum-headed Parakeet, Crested Serpent Eagle, Indian Grey Hornbill, Indian Roller, Malabar Pied Hornbill, Indian Peafowl, Steppe Eagle, White-breasted Kingfisher, Woodpeckers, Vultures and many more.
          </p>
          <div class="flex flex-wrap gap-2">
            <span style="background:rgba(245,158,11,0.12);border:1px solid rgba(245,158,11,0.3);color:#fbbf24;font-size:0.7rem;padding:0.3rem 0.8rem;border-radius:999px;font-family:'Roboto Mono',monospace;">Royal Bengal Tiger</span>
            <span style="background:rgba(245,158,11,0.12);border:1px solid rgba(245,158,11,0.3);color:#fbbf24;font-size:0.7rem;padding:0.3rem 0.8rem;border-radius:999px;font-family:'Roboto Mono',monospace;">Barasingha</span>
            <span style="background:rgba(245,158,11,0.12);border:1px solid rgba(245,158,11,0.3);color:#fbbf24;font-size:0.7rem;padding:0.3rem 0.8rem;border-radius:999px;font-family:'Roboto Mono',monospace;">Indian Leopard</span>
            <span style="background:rgba(245,158,11,0.12);border:1px solid rgba(245,158,11,0.3);color:#fbbf24;font-size:0.7rem;padding:0.3rem 0.8rem;border-radius:999px;font-family:'Roboto Mono',monospace;">Sloth Bear</span>
            <span style="background:rgba(245,158,11,0.12);border:1px solid rgba(245,158,11,0.3);color:#fbbf24;font-size:0.7rem;padding:0.3rem 0.8rem;border-radius:999px;font-family:'Roboto Mono',monospace;">Dhole</span>
            <span style="background:rgba(245,158,11,0.12);border:1px solid rgba(245,158,11,0.3);color:#fbbf24;font-size:0.7rem;padding:0.3rem 0.8rem;border-radius:999px;font-family:'Roboto Mono',monospace;">Indian Gaur</span>
            <span style="background:rgba(245,158,11,0.12);border:1px solid rgba(245,158,11,0.3);color:#fbbf24;font-size:0.7rem;padding:0.3rem 0.8rem;border-radius:999px;font-family:'Roboto Mono',monospace;">Chital</span>
            <span style="background:rgba(245,158,11,0.12);border:1px solid rgba(245,158,11,0.3);color:#fbbf24;font-size:0.7rem;padding:0.3rem 0.8rem;border-radius:999px;font-family:'Roboto Mono',monospace;">Sambar</span>
          </div>
        </div>
      </div>
        ...
        <div data-aos="fade-right">
          ...
          <div class="overflow-hidden rounded-xl border border-white/10">
            <div class="grid grid-cols-3 gap-0 bg-white/5 px-4 py-3">
              <span style="font-family:'Roboto Mono',monospace;font-size:.65rem;letter-spacing:.12em;color:#f59e0b;text-transform:uppercase;">Season</span>
              <span style="font-family:'Roboto Mono',monospace;font-size:.65rem;letter-spacing:.12em;color:#f59e0b;text-transform:uppercase;">Months</span>
              <span style="font-family:'Roboto Mono',monospace;font-size:.65rem;letter-spacing:.12em;color:#f59e0b;text-transform:uppercase;">Status</span>
            </div>
...
<!-- FAQs Section for Kanha Tiger Reserve Page -->
...
<script>
      ...
      <div class="grid lg:grid-cols-2 gap-12 items-center">
        <div>
          ...
          <div class="flex flex-wrap gap-4">
            <a href="contact.php" class="bg-white text-amber-800 hover:bg-amber-50 px-8 py-3 font-bold text-sm tracking-wider transition rounded-sm">BOOK YOUR STAY</a>
            <a href="Kanha-Safari-Tour-Package.php" class="border-2 border-white/50 hover:border-white text-white px-8 py-3 font-light text-sm tracking-wider transition rounded-sm">VIEW PACKAGES</a>
          </div>
        </div>
        <div class="grid grid-cols-2 gap-4">
          <div style="background:rgba(255,255,255,.08);border:1px solid rgba(255,255,255,.15);border-radius:.75rem;padding:1.5rem;text-align:center;">
  ...
  <a href="https://wa.me/9405529731" target="_blank"
    class="fixed bottom-4 right-4 md:bottom-8 md:right-8 bg-green-500 hover:bg-green-600 w-12 h-12 md:w-16 md:h-16 rounded-full flex items-center justify-center shadow-2xl z-50 transition transform hover:scale-110" aria-label="WhatsApp">
