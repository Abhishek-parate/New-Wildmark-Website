...
<head>
  ...
  <title>Kanha Safari Tour Package</title>
...
<body class="bg-black text-white">
  ...
  <header class="relative h-[50vh] md:h-[60vh] lg:h-[70vh] flex items-end"
    style="background: url('images/card2.webp') center/cover no-repeat">
  ...
  <section class="py-8 md:py-12 bg-black">
    <div class="max-w-7xl mx-auto text-center px-4">
      ...
      <div class="inline-flex items-center gap-1 bg-amber-600/20 backdrop-blur-sm px-3 md:px-4 py-2 rounded-full mb-4">
        ...
        <span class="text-xs font-semibold">Safaris: 2</span>
      </div>
      <div class="inline-flex items-center gap-1 bg-amber-600/20 backdrop-blur-sm px-3 md:px-4 py-2 rounded-full mb-4">
        <div class="flex gap-1 ml-2">
    ...
    <div class="max-w-6xl mx-auto px-4 md:px-6">
      ...
      <div class="grid md:grid-cols-2 gap-8 md:gap-12">
        ...
        <div class="panel" data-tab="machaan">
          <img src="images/family3.JPG" class="rounded-xl w-full h-64 object-cover" alt="Machaan" />
        </div>
        <div class="panel" data-tab="machaan">
        ...
        <div class="panel hidden" data-tab="superdeluxe">
          <img src="images/family4.jpg" class="rounded-xl w-full h-64 object-cover" alt="Super Deluxe" />
        </div>
        <div class="panel hidden" data-tab="superdeluxe">
        ...
        <div class="panel hidden" data-tab="family">
          <img src="images/beded2.webp" class="rounded-xl w-full h-64 object-cover" alt="Family" />
        </div>
        <div class="panel hidden" data-tab="family">
      ...
      <div class="space-y-10">
        ...
        <div class="grid md:grid-cols-12 gap-6 items-center">
          <div class="md:col-span-6 flex gap-3">
            ...
            <img class="w-1/2 h-32 md:h-40 object-cover rounded-lg" src="images/about4.webp" alt="Day 1" />
          </div>
        ...
        <div class="grid md:grid-cols-12 gap-6 items-center">
          <div class="md:col-span-6 flex gap-3">
            ...
            <img class="w-1/2 h-32 md:h-40 object-cover rounded-lg" src="images/beded2.webp" alt="Day 1" />
          </div>
          <div class="md:col-span-6">
            ...
            <ul class="grid grid-cols-1 sm:grid-cols-1 gap-2 text-gray-300 text-sm">
              <li>
                <i class="fa-solid fa-check icon-check mr-2 mb-2"></i>Morning
                breakfast will be served by 8.30 AM.
              </li>
              <li>
                <i class="fa-solid fa-check icon-check mr-2 mb-2"></i>Time to
                say Good Bye.
      ...
      <div>
        <div class="experience-panel-a" data-tab-a="curated">
          <div class="grid md:grid-cols-2 gap-8 items-center">
            <img src="images/wildmark9.jpg" class="rounded-xl w-full h-64 object-cover" alt="Payment" />
            <div>
        ...
        <div class="experience-panel-a hidden" data-tab-a="dining">
          <div class="grid md:grid-cols-2 gap-8 items-center">
            <img src="images/home6.webp" class="rounded-xl w-full h-64 object-cover"
              alt="Cancellation" />
            <div>
              <h3 class="text-2xl font-serif font-bold text-amber-100 mb-4">
                Refund policies:
        ...
        <div class="faq-answer max-h-0 overflow-hidden transition-all duration-300 ease-in-out">
          <div class="px-6 py-5 bg-neutral-800/50 border-t border-neutral-700">
            ...
            <ul class="text-sm md:text-base text-gray-300 space-y-3 ml-4">
              <li class="flex items-start gap-2">
                <span class="text-amber-500">•</span>
                <span><strong>Kanha Core Zone (Morning Safari):</strong> The most popular safari zone covering a large part of the core area. Known for exceptional scenic beauty, high chances of spotting Bengal Tigers (including the famous Tigress Neelam), Barahsingha (swamp deer), and diverse wildlife. This zone offers the quintessential Kanha experience.</span>
              </li>
              <li class="flex items-start gap-2">
                <span class="text-amber-500">•</span>
...
<!-- FAQ JavaScript -->
  ...
  <script>
    ...
    if (
      ...
      document.querySelector(".packageSwiper")
    ) {
      const packageSwiper = new Swiper(".packageSwiper", {
        // Show slides per view
        slidesPerView: 1,
        spaceBetween: 20,
