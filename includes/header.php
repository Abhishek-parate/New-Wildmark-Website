...
<body style="background-color:var(--bg2);color:var(--txt1)">
                ...
                <div class="border rounded-xl p-5 transition"
                    ...
                    <div class="flex items-start justify-between mb-3">
                        <div>
                            ...
                            <h4 class="text-xl font-serif font-bold" style="color: var(--text1) !important;">2N/3D
                                Resort +
                                Safari Package</h4>
                        </div>
                    ...
                    <ul class="text-sm space-y-2 mb-4" style="color: var(--text1);">
                        <li class="flex items-center gap-2"><svg class="w-4 h-4 flex-shrink-0"
                                style="color: var(--text2);" fill="currentColor" viewBox="0 0 20 20">
                                <path fill-rule="evenodd"
                ...
                <div class="border rounded-xl p-5 transition"
                    ...
                    <div class="flex items-start justify-between mb-3">
                        <div>
                            ...
                            <h4 class="text-xl font-serif font-bold" style="color: var(--text1) !important;">Advance
                                Booking
                                Discount</h4>
                        </div>
                        <div class="text-right">
                    ...
                    <p class="text-sm mb-4" style="color: var(--text1);">Book 30 days in advance and save 20% on all
                        resort
                ...
                <div class="border rounded-xl p-5 transition"
                    ...
                    <div class="flex items-start justify-between mb-3">
                        <div>
                            ...
                            <h4 class="text-xl font-serif font-bold" style="color: var(--text1) !important;">Group
                                Booking
                                Special</h4>
                        </div>
                        <div class="text-right">
                    ...
                    <p class="text-sm mb-4" style="color: var(--text1);">Special rates for groups of 6+ people. Perfect
                        for
    ...
    <a href="https://wa.me/918830996719?text=Hello%20I%20would%20like%20to%20enquire%20about%20room%20availability%20and%20packages%20at%20Wildmark%20Resort.%20Please%20share%20details." target="_blank"
        ...
        <div class="w-full max-w-[1400px] mx-auto px-3 md:px-6 py-2 md:py-0">
            ...
            <div class="hidden md:flex items-center gap-6 py-2">
                ...
                <div class="flex-shrink-0" style="width:150px">
                    <a href="https://wildmarkresort.com/contact/"
                        class="btn-book block w-full text-center text-xs lg:text-sm">
                        BOOK NOW
                    </a>
                </div>
            </div>
