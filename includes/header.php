...
<head>
    ...
    *::after {
    ...
    /* Ensure hamburger button is always tappable on touch devices */
    #mobileMenuBtn {
        cursor: pointer;
    ...
    /* ── CRITICAL FIX: Navbar must always be fully interactive ── */
    nav.navbar-root,
    nav.navbar-root *,
    #mobileMenuBtn,
    #mobilePackagesBtn,
...
<body class="<?php echo htmlspecialchars($pageSlug); ?>" style="background-color:var(--bg2);color:var(--txt1);">
    ...
    <div id="specialOfferPopup"
        ...
        <div class="border-2 rounded-2xl max-w-2xl w-full max-h-[90vh] overflow-y-auto relative"
            ...
            <div class="p-6 md:p-8 rounded-t-2xl" style="background: linear-gradient(to right, var(--txt2), #b01e1e);">
                ...
                <div class="border rounded-xl p-5"
                    ...
                    <ul class="text-sm space-y-2 mb-4" style="color: var(--txt1);">
                        <li class="flex items-center gap-2">
                            <svg class="w-4 h-4 flex-shrink-0" style="color: var(--txt2);" fill="currentColor"
                                viewBox="0 0 20 20">
                                <path fill-rule="evenodd"
    ...
    <!-- ── NAVBAR ── -->
    <nav class="navbar-root fixed w-full z-50 py-0">
        ...
        <div class="w-full max-w-[1400px] mx-auto px-3 md:px-6 py-2 md:py-0">
            ...
            <div class="flex md:hidden justify-between items-center relative py-2">
                <button id="mobileMenuBtn" class="hamburger-icon transition z-20 p-1"
                    onclick="(function(){var m=document.getElementById('mobileMenu');if(m){m.classList.toggle('active');}})()">
            ...
            <div class="py-2">
                ...
                <div>
                    <button id="mobilePackagesBtn" class="mobile-pkg-btn"
                        onclick="(function(){var d=document.getElementById('mobilePackagesDropdown');var a=document.getElementById('packagesArrow');if(d){d.classList.toggle('active');}if(a){a.classList.toggle('rotate-180');}})()">
                        <span>Packages</span>
                ...
                <div>
                    <div class="flex items-center justify-between border-b border-[rgba(232,201,153,0.3)]">
                        ...
                        <!-- Dropdown Toggle -->
                        <button id="mobileRoomsBtn" class="p-4" type="button"
                            onclick="(function(){var d=document.getElementById('mobileRoomsDropdown');var a=document.getElementById('roomsArrow');if(d){d.classList.toggle('active');}if(a){a.classList.toggle('rotate-180');}})()">
    ...
    <script>
    // ── MOBILE MENU TOGGLE (robust, works on all browsers) ──
    document.addEventListener('DOMContentLoaded', function() {

        var menuBtn = document.getElementById('mobileMenuBtn');
        var mobileMenu = document.getElementById('mobileMenu');
        var packagesBtn = document.getElementById('mobilePackagesBtn');
        var packagesDropdown = document.getElementById('mobilePackagesDropdown');
        var packagesArrow = document.getElementById('packagesArrow');
        var roomsBtn = document.getElementById('mobileRoomsBtn');
        var roomsDropdown = document.getElementById('mobileRoomsDropdown');
        ...
        if (packagesBtn && packagesDropdown) {
            packagesBtn.addEventListener('click', function(e) {
                ...
                if (packagesArrow) packagesArrow.classList.toggle('rotate-180');
            });
        }

        if (roomsBtn && roomsDropdown) {
            roomsBtn.addEventListener('click', function(e) {
                e.stopPropagation();
                roomsDropdown.classList.toggle('active');
                if (roomsArrow) roomsArrow.classList.toggle('rotate-180');
            });
        }
