        ...
        <div class="grid md:grid-cols-4 gap-8 mb-8">
            ...
            <div>
                ...
                <p class="text-gray-400 text-sm mb-4">
                    Unforgettable Wildlife Adventure Await at Kanha Jungle Safari. See tigers, deer, leopards & more on
                    a
            ...
            <div>
                ...
                <ul class="space-y-2 text-sm">
                    ...
                    <li>
                        <a href="Terms-and-Conditions.php" class="text-gray-400 hover:text-amber-500 transition">Terms
                            and Conditions</a>
                    </li>
                    <li>
            ...
            <div>
                ...
                <ul class="space-y-3 text-sm text-gray-400">
                    ...
                    <li class="flex items-center gap-2">
                        ...
                        <a href="mailto:info@wildmarkresort.com"
                            class="text-gray-400 hover:text-amber-500 transition">info@wildmarkresort.com</a>
                    </li>
                    <li class="flex items-center gap-2">
...
if (mobileRoomsBtn && mobileRoomsDropdown && roomsArrow) {
    mobileRoomsBtn.addEventListener("click", (e) => {
        ...
        if (mobileRoomsDropdown.classList.contains("active")) {
            roomsArrow.style.transform = "rotate(180deg)";
        } else {
            roomsArrow.style.transform = "rotate(0deg)";
        }
    });
}
...
document.addEventListener("click", (e) => {
    if (mobileMenu && mobileMenuBtn) {
        if (!mobileMenu.contains(e.target) && !mobileMenuBtn.contains(e.target)) {
            ...
            if (mobileRoomsDropdown) {
                mobileRoomsDropdown.classList.remove("active");
            }
            if (roomsArrow) {
                roomsArrow.style.transform = "rotate(0deg)";
            }
